...
//	}
   ...
   // @SuppressWarnings({ "unused" })
    ...
    public static UserEntity toActivitiUser(UserInfo user){
        if (user == null){
            return null;
        }
    ...
    public static GroupEntity toActivitiGroup(RoleInfo role){
        if (role == null){
            return null;
        }
        GroupEntity groupEntity = new GroupEntity();
        groupEntity.setId(role.getDutyid());
        groupEntity.setName(role.getDutyname());
