...
public class SourceHouseController {
    ...
    public Object getReturnHouseFile(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            Map<String,Object> resultMap = sourceHouseService.updateReturnHpuseFile(applyid,request, response);
            return resultMap;
        } catch (Exception e) {
            e.printStackTrace();
            return "打印审批表失败!";
    ...
    public Object getJSFHouseFile(HttpServletRequest request){
        ...
        try {
            Map<String,Object> resultMap= sourceHouseService.updateJSFHouseFile(applyid,request);
            return resultMap;
        } catch (Exception e) {
            e.printStackTrace();
            return "打印审批表失败!";
