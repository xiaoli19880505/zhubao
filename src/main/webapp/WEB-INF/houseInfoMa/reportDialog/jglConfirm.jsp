...
<div data-options="region:'center',border:false">
    <form class='easyui-form' id='form' method='post'>
        <div class="contract">
            <div class="conPage">
                <div class="conTitle">${year}年徐州市经济适用住房（${ssq}）</div>
                <div class="conTitle">选房确认单（存根联）</div>
                <div class="conTitle">选房顺序号：【${factMapping.num}】</div>
                <div class="conContent" style="margin-top: 20px">
                    申请人：${username}身份证号：${sfzh}
                </div>
