    ...
    <div id="top">
        <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
            ...
            <ul class="input-group">
                <li>
                    <input class="easyui-textbox" name="afgDwmc" style="width: 92%" data-options="label:'单位名称:',required:true,prompt:'请输入单位全称'">
                </li>
                <li>
                ...
                <li>
                    <input class="easyui-combobox" name="afgDwdz" id="afgDwdz" style="width: 92%" data-options="label:'单位所在街道办事处:',required:true,valueField:'piItemcode',textField:'piItemname',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                </li>
            </ul>
            <!--进度条-->
            <div id="procsss">
            ...
            <div id="inner">
                <div>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li style="display: none">
                            <input class="easyui-textbox" name="afgSqrid" id="afgSqrid" style="width: 92%" data-options="label:'afgSqrid'">
                        </li>
                        <li style="display: none">
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmSfzh" id="applyFamilyMembers0afmSfzh" style="width: 92%" data-options="label:'身份证号:',required:true,validType:['sfz'],readonly:true">
                        </li>
                        <li>
                        ...
                        <li>
                            <input class="easyui-textbox" name="afgGrnsr" id="applyFamilyMembers0afmNsr" style="width: 92%" data-options="label:'个人年收入(元):',required:true,validType:'number',events:{keyup:changeSr}">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        <legend>配偶信息</legend>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="afgJtrks" id="afgJtrks" style="width: 92%" data-options="label:'家庭人口:',readonly:true,validType:['numberZ','empty']">
                        </li>
                ...
                <div style="display: none;">
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyHouses[0].afhRjmj" id="applyFamilyHouses0afhRjmj" style="width: 92%" data-options="label:'人均建筑面积(m²):',required:true,validType:'number'">
                        </li>
                        <li>
...
<script>
    ...
    function addPerson() {
        ...
        if(person){
            ...
            var perString=$('<ul class="input-group windowInner">' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers['+addIndex+'].afmNsr" id="applyFamilyMembers'+addIndex+'afmNsr" style="width: 92%" value="0" data-options="label:\'个人年收入(元):\',required:true,validType:\'number\',events:{keyup:changeSr}">' +
                '</li>' +
        ...
        if(data.applyFamilyMembers.length>2){
            for(var i = 2; i< data.applyFamilyMembers.length;i++){
                 $('<ul class="input-group windowInner">' +
                    ...
                    '</li>' +
                     '<li class="readonly">' +
                     '<input class="easyui-combobox" name="applyFamilyMembers['+i+'].afmYsqrgx" id="applyFamilyMembers'+i+'afmYsqrgx" style="width: 92%" data-options="label:\'关系:\',valueField:\'piItemname\',textField:\'piItemname\',url:\'<%=basePath %>ParmItem/findFamylyOnlypozn\',required:true,readonly:true,editable:false,panelHeight:\'auto\',panelMaxHeight:\'280\'">' +
                     '</li>' +
                     '<li>' +
    ...
    function setValue(form,data){
        ...
        bank.biography().setParams({row:data.afgBaseimg,title:'sign'});
    }
    //图片回显
