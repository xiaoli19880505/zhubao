    ...
    function addPerson() {
       ...
       if(person){
           ...
           var perString=$('<ul class="input-group windowInner">' +
               ...
               '</li>' +
               '<li>' +
               '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex + '].afmSfzh" id="applyFamilyMembers' + addIndex + 'afmSfzh" style="width: 92%" data-options="label:\'身份号码:\',required:true,validType:[\'sfz\'],events:{keyup:setBirthday}">' +
               '</li>' +
               '<li>' +
