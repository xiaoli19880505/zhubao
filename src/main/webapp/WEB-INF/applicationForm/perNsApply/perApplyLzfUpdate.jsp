            ...
            <div id="inner">
                ...
                <div>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox"  value="${sessionScope.applyUserinfo.username}" name="applyFamilyMembers[0].afmXm" id="applyFamilyMembers0afmXm" style="width: 92%"
                                   data-options="label:'姓名:',required:true,readonly:true,validType:['empty','chinese','specialCharacter']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox"  value="${sessionScope.applyUserinfo.sfzh}" name="applyFamilyMembers[0].afmSfzh" id="applyFamilyMembers0afmSfzh" style="width: 92%"
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmGzdw" id="applyFamilyMembers0afmGzdw" style="width: 92%"
                                   data-options="label:'工作单位:',required:true,prompt:'请输入单位全称'">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmLxdh" id="applyFamilyMembers0afmLxdh" value="${sessionScope.applyUserinfo.linktel}" style="width: 92%"
                                   data-options="label:'联系电话:',required:true,validType:'phone',readonly:true">
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <input type="checkbox" id="apTsjt" value="2" />二级以上下肢重度残疾
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        <legend>配偶信息</legend>
                    ...
                    <ul class="input-group windowInner">
                        <legend>户籍信息</legend>
                        <li>
                            <input class="easyui-textbox" name="apSqhjnx" id="apSqhjnx" style="width: 92%"
                                   data-options="label:'户籍年限(年):',required:true,validType:['numberZ','limitHJ[5]','empty']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="apJtnsr" id="apJtnsr" style="width: 92%"
                                   data-options="label:'家庭年收入(元):',required:true,readonly:true,validType:['number','empty']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="apJtrk" id="apJtrk" style="width: 92%"
                                   data-options="label:'家庭人口:',required:true,readonly:true,validType:['numberZ','empty']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="apRjysr" id="apRjysr" style="width: 92%"
                                   data-options="label:'人均月收入(元):',required:true,readonly:true,validType:['number','empty']">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                ...
                <div style="display: none;">
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouses[0].afhZl" id="applyFamilyHouses0afhZl" style="width: 92%"
                                   data-options="label:'房屋地址:',required:true,validType:['empty']">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouses[0].afhCqr" id="applyFamilyHouses0afhCqr" style="width: 92%"
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyHouses[0].afhRjmj" id="applyFamilyHouses0afhRjmj" style="width: 92%"
                                   data-options="label:'人均建筑面积(m²):',readonly:true,validType:['number','empty']">
                        </li>
                        <li>
                            <input class="easyui-combobox" name="applyFamilyHouses[0].afhZfxz" id="applyFamilyHouses0afhZfxz" style="width: 92%"
                                   data-options="label:'现住房性质:',required:true,valueField:'piItemcode',textField:'piItemname',
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfzl" id="applyFamilyHouseChangeafhcAzfzl" style="width: 92%"
                                   data-options="label:'安置房地址:',validType:['empty'],prompt:'非必填'">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfjzmj" id="applyFamilyHouseChangeafhcAzfjzmj" style="width: 92%"
                                   data-options="label:'建筑面积(m²):',validType:['number','empty'],prompt:'非必填'">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        <legend>低保/特困信息</legend>
                        <li>
                            <input class="easyui-textbox" name="apDbzbh" style="width: 92%" data-options="label:'低保/特困证编号:',required:true">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="apLqrs" style="width: 92%" data-options="label:'低保/特困领取人数:',required:true,validType:['numberZ','empty']">
                        </li>
                        <li>
                            <input class="easyui-datebox" name="apFzsj" style="width: 92%" data-options="label:'低保/特困发证时间',required:true,editable:false,validType:['minDate','dbAnnual']">
                        </li>
                    </ul>
                    <p class="sbumit right">
                        <span><a href="#">下一步</a></span>
...
<script>
    var person=false;var i=1;//初始化人数
    ...
    function addPerson() {
        ...
        if(person) {
            ...
            var perString = $('<ul class="input-group windowInner">' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex + '].afmXm" id="applyFamilyMembers' + addIndex + 'afmXm" style="width: 92%" data-options="label:\'姓名:\',required:true,validType:[\'chinese\',\'specialCharacter\']">' +
                '</li>' +
                '<li class="readonly">' +
                '<input class="easyui-datebox" name="applyFamilyMembers[' + addIndex + '].afmCsny" id="applyFamilyMembers' + addIndex + 'afmCsny" style="width: 92%" data-options="label:\'出生年月:\',required:true,readonly:true">' +
                '</li>' +
                '<li>' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex + '].afmSfzh" id="applyFamilyMembers' + addIndex + 'afmSfzh" style="width: 92%" data-options="label:\'身份号码:\',required:true,validType:[\'sfz\'],events:{blur:setBirthday}">' +
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex+ '].afmNsr" id="applyFamilyMembers' + addIndex+ 'afmNsr" value="0" style="width: 92%" data-options="label:\'个人年收入(元):\',required:true,events:{keyup:changeSr}">' +
                '</li>' +
