    ...
    <div id="top">
        <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
            <ul class="input-group">
                   <li>
                       <input class="easyui-combobox" name="abSsq" style="width: 92%" data-options="label:'户籍所在区（县）:',required:true,valueField:'piItemcode',textField:'piItemname',
                       url:'<%=basePath %>ParmItem/selectSsqExceptCenter',onSelect:selectSSQ,editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                   </li>
                   <li>
                       <input class="easyui-combobox" name="abJdbsc" id="abJdbsc"  style="width: 92%" data-options="label:'街道办事处:',required:true,valueField:'piItemcode',textField:'piItemname',
                       editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                   </li>
                <li>
                    <input class="easyui-textbox" name="abSqjwh" style="width: 92%" data-options="label:'户籍所在社区:',required:true,validType:['chinese','empty']">
                </li>
            </ul>
            <!--进度条-->
            <div id="procsss">
            ...
            <div id="inner">
                ...
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li style="text-align: left" class="butieli">
                            ...
                            <input type="checkbox" value="3" /><label class="lispan">二级以上下肢重度残疾</label>
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        <legend>配偶信息</legend>
                 ...
                 <ul class="input-group windowInner">
                        <legend>户籍信息</legend>
                        <li>
                            <input class="easyui-textbox" name="abSqhjnx" style="width: 92%" data-options="label:'户籍年限(年)',required:true,validType:['empty','numberZ','limitHJ[5]']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="abJtnsr" id="abJtnsr" style="width: 92%" data-options="label:'家庭年收入(元):',readonly:true,required:true,validType:['number','empty']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="abJtrk"  id="abJtrk" value="1" style="width: 92%" data-options="label:'家庭人口:',readonly:true,required:true,validType:['numberZ','empty']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="abRjysr" id="abRjysr" style="width: 92%" data-options="label:'人均月收入(元):',readonly:true,required:true,validType:['number','empty']">
                        </li>
                    </ul>
                   <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyUnit.bsls" style="width: 92%" data-options="label:'统一社会信用代码:',prompt:'非必填',validType:'xyCode'">
                        </li>
                        <li>
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyUnit.tel" style="width:92%" data-options="label:'联系方式:',validType:'phoneTel',prompt:'非必填'">
                        </li>
                        <li>
                ...
                <div style="display: none;">
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcYzfzl" style="width: 92%" data-options="label:'原住房地址:',validType:['empty']">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcCqr" style="width: 92%" data-options="label:'原产权人:',validType:['empty','chinese','specialCharacter']">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcJzmj" style="width: 92%" data-options="label:'建筑面积(m²):',validType:['number','empty']">
                        </li>
                        <li>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="abDbzbh" style="width: 92%" data-options="label:'低保/特困证编号:',required:true">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="abLqrs" style="width: 92%" data-options="label:'低保/特困领取人数:',required:true,validType:['numberZ','empty']">
                        </li>
                        <li>
                            <input class="easyui-datebox" name="abFzsj" style="width: 92%" data-options="label:'低保/特困发证时间',required:true,editable:false,validType:['minDate','dbAnnual']">
                        </li>
                    </ul>
                    <p class="sbumit right">
                        <span><a href="#">下一步</a></span>
...
<script>
    ...
    function secondSave() {
        ...
        var abRjysr=$.trim($("#abRjysr").textbox('getValue'));
        $('#form').form('submit', {
            url: '<%=basePath %>applyButie/addApplyInfo',
            onSubmit: function (param) {
                param.abBaseimg = signApply.row;
                //二级伤残赋值
    ...
    function addPerson() {
        ...
        if(person){
            ...
            var perString=$('<ul class="input-group windowInner">' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-combobox" name="applyFamilyMembers['+ addIndex +'].afmHyzk" id="applyFamilyMembers'+ addIndex +'afmHyzk" style="width: 92%" data-options="label:\'婚姻状况:\',valueField:\'piItemcode\',textField:\'piItemname\',url:\'<%=basePath %>ParmItem/getOptions?parmSetcode=07\',required:true,editable:false,panelHeight:\'auto\',panelMaxHeight:\'280\'">' +
                '</li>' +
                '<li>' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex + '].afmSfzh" id="applyFamilyMembers' + addIndex + 'afmSfzh" style="width: 92%" data-options="label:\'身份证号码:\',required:true,validType:[\'sfz\',\'empty\'],events:{keyup:setBirthday}">' +
                '</li>' +
                '<li>' +
    ...
    function changeSr(obj){
        ...
        //计算年收入，平均收入
        $("#abJtnsr").textbox('setValue',sum);
        $("#abRjysr").textbox('setValue',average);
    }
