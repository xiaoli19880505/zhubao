	...
	<div class="easyui-panel windowPanel">
		...
		<form method="post" id="form" class="easyui-form">
			<ul class="search-group windowInner">
				<legend>基本信息</legend>
				<li style="width: 370px"><input class="easyui-textbox" name="columnCode" style="width: 92%" data-options="label:'栏目编码:',required:true,validType:['empty']"></li>
				<li style="width: 370px"><input class="easyui-textbox" name="columnName" style="width: 92%" data-options="label:'栏目名称:',required:true,validType:['empty']"></li>
				<li style="width: 370px"><input class="easyui-textbox" name="sequence" style="width: 92%" data-options="label:'栏目排序位置:',required:true,validType:['empty']"></li>
				<li style="width: 370px">
					<select class="easyui-combobox" name="downFlag" style="width: 92%" data-options="label:'下载中心:',required:true,validType:['empty']">
...
<script>
    function saveAdd() {
        bank.ajaxForm('#form','<%=basePath %>columnInfo/saveColumnInfo',{},function(data){
