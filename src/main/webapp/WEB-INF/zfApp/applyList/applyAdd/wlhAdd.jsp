						...
						<div id="wrap3" style="display: none;">
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="affJtrks" id="affJtrks"  value="1" data-options="label:'家庭人口',readonly:true,validType:['numberZ','empty']">
										</div>
										<div class="commonRow">
										...
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="affJtnsr" id="affJtnsr"  data-options="label:'家庭年收入(元)',readonly:true,validType:['empty','number']">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="affRjysr" id="affRjysr"  data-options="label:'人均月收入(元)',readonly:true,validType:['empty','number']">
										</div>
									</div>
								</div>
							</div>
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow">
											<input class="easyui-textbox" name="applyFamilyHouse.afhZl"  data-options="label:'房屋地址',required:true,validType:['empty']">
										</div>
										<div class="commonRow">
											<input class="easyui-textbox" name="applyFamilyHouse.afhCqr"  data-options="label:'产权人',required:true,validType:['empty','chinese','specialCharacter']">
										</div>
										<div class="commonRow">
										...
										<div class="commonRow">
											<input class="easyui-combobox" name="applyFamilyHouse.afhZfxz" data-options="label:'现住房性质',required:true,valueField:'piItemcode',textField:'piItemname',
