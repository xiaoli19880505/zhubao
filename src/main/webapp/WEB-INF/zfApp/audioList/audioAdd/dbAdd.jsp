					...
					<div id="wrap2" style="display: none;">
							...
							<div class="mui-card-content" >
								<div class="mui-input-group">
									<div class="commonRow">
										...
										url:'<%=basePath %>ParmItem/selectSsqExceptCenter',onSelect:selectSSQ,editable:false,panelHeight:'auto',panelMaxHeight:'280'">		</div>
									<div class="commonRow">
							...
							<div class="mui-card-content" >
								<div class="mui-input-group">
									<div class="commonRow readonlyRow">
										<input class="easyui-textbox" name="applyFamilyMembers[0].afmXm" id="applyFamilyMembers0afmXm" value="${sessionScope.applyUserinfo.username}"  data-options="label:'姓名',required:true,readonly:true">
									</div>
									<div class="commonRow readonlyRow">
										<input class="easyui-textbox" name="applyFamilyMembers[0].afmSfzh" id="applyFamilyMembers0afmSfzh" value="${sessionScope.applyUserinfo.sfzh}"  data-options="label:'身份证号码',required:true,validType:'sfz',readonly:true">
									</div>
									<div class="commonRow readonlyRow">
									...
									<div class="commonRow readonlyRow">
										<input class="easyui-textbox" name="applyFamilyMembers[0].afmLxdh" value="${sessionScope.applyUserinfo.linktel}"  data-options="label:'联系电话',required:true,validType:'numberZ',readonly:true">
									</div>
									<div class="commonRow">
									...
									<div  class="commonRow">
										...
										<input type="checkbox" name="apTsjt" value="2" />
										<label class="lispan">二级以上下肢重度残疾</label>
									</div>
								</div>
							</div>
						</div>
						<div class="mui-card">
							...
							<div class="mui-card-content" >
								<div class="mui-input-group">
									...
									<div class="commonRow">
										<select class="easyui-combobox" name="applyFamilyMembers[1].afmXb" id="applyFamilyMembers1afmXb"   data-options="label:'性别',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
											<option value="女">女</option>
											<option value="男">男</option>
										</select>
									</div>
						...
						<div class="mui-card">
							...
							<div class="mui-card-content" >
								<div class="mui-input-group">
									<div class="commonRow">
										<input class="easyui-textbox" name="apSqhjnx"  data-options="label:'户籍年限',required:true,validType:['numberZ','limitHJ[5]','empty']">
									</div>
									<div class="commonRow readonlyRow">
						...
						<div class="mui-card">
							...
							<div class="mui-card-content" >
								<div class="mui-input-group">
									...
									<div class="commonRow">
										<input class="easyui-combobox" name="applyFamilyHouses[0].afhZfxz" id="applyFamilyHouses0afhZfxz"  data-options="label:'现住房性质',required:true,valueField:'piItemcode',
					...
					<div id="wrap4" style="display: none;">
						<div class="mui-card">
							...
							<div class="mui-card-content" >
								<div class="mui-input-group">
									<div class="commonRow">
										<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfzl" data-options="label:'安置房地址'">
									</div>
									<div class="commonRow">
