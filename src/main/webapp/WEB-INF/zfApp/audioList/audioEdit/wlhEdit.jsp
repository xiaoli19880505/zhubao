            ...
            <div class="mui-scroll">
                <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
                        ...
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="affDwmc" data-options="label:'单位名称',required:true,prompt:'请输入单位全称'">
                                    </div>
                                    <div class="commonRow">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-combobox" name="apJdbsc" id="apJdbsc"
                                               data-options="label:'单位所在街道办事处',required:true,valueField:'piItemcode',textField:'piItemname',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    ...
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="applyFamilyMembers[0].afmSfzh" id="applyFamilyMembers0afmSfzh"
                                               data-options="label:'身份证号码',required:true,validType:['sfz','empty'],readonly:true">
                                    </div>
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="applyFamilyMembers[0].afmLxdh" id="applyFamilyMembers0afmLxdh"
                                               data-options="label:'联系电话',required:true,validType:['phone','empty'],readonly:true">
                                    </div>
                                    <div class="commonRow">
                        ...
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    ...
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="apJtnsr" id="apJtnsr" data-options="label:'家庭年收入(元)',required:true,validType:'number',readonly:true">
                                    </div>
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="apRjysr" id="apRjysr" data-options="label:'人均月收入(元)',required:true,validType:'number',readonly:true">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    ...
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="applyFamilyHouses[0].afhRjmj" id="applyFamilyHouses0afhRjmj" data-options="label:'人均建筑面积(m²)',validType:['number','empty'],readonly:true">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-combobox" name="applyFamilyHouses[0].afhZfxz" id="applyFamilyHouses0afhZfxz" data-options="label:'现住房性质',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=01'">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="wrap4" style="display: none;">
                        ...
                        <div class="mui-card">
                            <!--页眉，放置标题-->
                            <div class="mui-card-header"><span><span class="name">住房状况证明材料</span><span class="reqSpan">*(必填)</span></span><span id="type6" class="detail">详情</span>
                            </div>
                            <!--内容区-->
                            <div class="mui-card-content">
...
<script>
    mui.init();
    var person = false;var i=1;//控制人口变量
    ...
    mui(".mui-card").on('tap', '.greenPan', function (e) {
        ...
        if (person) {
            ...
            var perString = $('<div class="mui-card">' +
                ...
                '            </div>' +
                '            <div class="commonRow">' +
                '					<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex+ '].afmNsr" id="applyFamilyMembers' + addIndex+ 'afmNsr" value="0" data-options="label:\'年收入(元)\',required:true,validType:\'number\',events:{keyup:changeSr}">' +
                '            </div>' +
                '       </div>' +
                '     </div>' +
        ...
        if (data.applyFamilyMembers.length > 2) {
            for (var i = 2; i < data.applyFamilyMembers.length; i++) {
                $('<div class="mui-card">' +
                    ...
                    '					url:\'<%=basePath %>ParmItem/findFamylyOnlypozn\',required:true,readonly:true,editable:false,panelHeight:\'auto\',panelMaxHeight:\'280\'">' +
                    '				</div>' +
                    '            <div class="commonRow">' +
    ...
    function selecthyzk(record){
        ...
        if(record.piItemcode=="2"){
            ...
            $('#applyFamilyMembers1afmXm,#applyFamilyMembers1afmSfzh,#applyFamilyMembers1afmLxdh,#applyFamilyMembers1afmNsr,#applyFamilyMembers1afmYsqrgx,#applyFamilyMembers1afmXb,#applyFamilyMembers1afmGzdw').textbox({required:false,dreadonly:true});
