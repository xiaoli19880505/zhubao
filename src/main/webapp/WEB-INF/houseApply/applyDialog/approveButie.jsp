...
<body class="easyui-layout" id="butie">
<div data-options="region:'center',border:false">
	...
	<div class="easyui-panel resPanel" style="width: 100%;height: 98%;overflow: auto;position: relative">
		<div class="applyContainer">
			<div class="applyTitle"><span>低保特困住保补贴申请</span></div>
			<div class="applyContent">
				<form method="post" id="form" class="easyui-form">
					<ul class="apply-group windowInner">
						<li class="readonly">
							<input class="easyui-combobox" name="abSsq" style="width: 92%" data-options="label:'户籍所在区（县）:',readonly:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=05'">
						</li>
						<li class="readonly">
							<input class="easyui-combobox" name="abJdbsc" style="width: 92%" data-options="label:'户籍所在街道办事处:',readonly:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=06'">
						</li>
						<li>
							<input class="easyui-textbox" name="abSqjwh" style="width: 92%" data-options="label:'户籍所在社区:',required:true,readonly:true">
						</li>
					</ul>
					<div class="applyTab">
					...
					<div id="inner">
							...
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyMembers[0].afmNsr" id="applyFamilyMembers0afmNsr" style="width: 92%"
										   data-options="label:'个人年收入(元):',readonly:true,validType:['number','empty']">
								</li>
								<li style="text-align: left" class="butieli">
									<label class="lilabel">是否特殊家庭:</label>
									<input type="checkbox" name="abTsjt" value="3" disabled style="margin-left: 21px"/><label class="lispan">二级以上下肢重度残疾</label>
								</li>
							</ul>
							<ul class="apply-group windowInner">
								<legend>配偶信息</legend>
								...
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyMembers[1].afmNsr" id="applyFamilyMembers1afmNsr" style="width: 92%"
										   data-options="label:'年收入(元):',readonly:true,validType:['number','empty']">
								</li>
							</ul>
							<ul class="apply-group windowInner">
								<legend>户籍信息</legend>
								<li class="readonly">
									<input class="easyui-textbox" name="abSqhjnx" style="width: 92%" data-options="label:'户籍年限(年)',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="abJtnsr" style="width: 92%" data-options="label:'家庭年收入(元):',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="abJtrk" style="width: 92%" data-options="label:'家庭人口:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="abRjysr" style="width: 92%" data-options="label:'人均月收入(元):',readonly:true">
								</li>
							</ul>
							<ul class="apply-group windowInner">
						...
						<div style="display: none;">
							<ul class="apply-group windowInner" id="addHouse">
							...
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyHouseChange.afhcYzfzl" id="applyFamilyHouseChangeafhcYzfzl" style="width: 92%" data-options="label:'原住房地址:',readonly:true">
								</li>
								<li class="readonly">
							...
							<ul class="apply-group windowInner" >
								<legend>安置信息</legend>
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfzl" id="applyFamilyHouseChangeafhcAzfzl" style="width: 92%" data-options="label:'安置房地址:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfjzmj" id="applyFamilyHouseChangeafhcAzfjzmj" style="width: 92%" data-options="label:'建筑面积(m²):',readonly:true">
								</li>
							</ul>
							<ul class="apply-group windowInner">
								<legend>低保/特困信息</legend>
								<li class="readonly">
									<input class="easyui-textbox" name="abDbzbh" id="abDbzbh" style="width: 92%" data-options="label:'低保/特困证编号:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="abLqrs" id="abLqrs" style="width: 92%" data-options="label:'低保/特困领取人数:',readonly:true,validType:['numberZ','empty']">
								</li>
								<li class="readonly">
									<input class="easyui-datebox" name="abFzsj" id="abFzsj" style="width: 92%" data-options="label:'低保/特困发证时间',readonly:true,editable:false,validType:['minDate']">
								</li>
							</ul>
						</div>
...
<div data-options="region:'south',border:false">
	<div class="auditRestlt">
		<div class="opion">
			<input id="comment" class="easyui-textbox" name="opion" style="width: 98%;height: 100px" data-options="label:'审核意见:',multiline:true,required:true">
		</div>
		<ul class="search-group">
			...
			<li class="time" style="display: none;width: 380px">
				<input class="easyui-datebox" id="sendTime" style="width:92%" data-options="label:'通知签订补贴协议时间',validType:['overDate'],required:true,editable:false">
			</li>
...
<script>
    ...
    $(function () {
        if("${reaudit}"=="0"){
            $(".time label").text("通知原件核验时间");
            mesData.temType="2";
        }else if("${reaudit}"=="2"){
            $(".time label").text("通知签订补贴协议时间");
            mesData.temType="5";
        }
        if("${chengxin}"=="chengxin"){
            $('#butie').layout('remove','south');
        }
        if("${chengxin}"=="gongshi"){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                bank.biography().setParams({row:data.abBaseimg,title:'searchSign'});
            },error:function(){
    ...
    function submit(){
        ...
        if(flag){
            ...
            if(approveResult.length>0&&comment.length>0){
                if(approveResult=="1" && "${gzfExt}"=="1"){
                    flag=true;
                    bank.alertMessage("申请用户享有低保特困公租，请通知走退房手续进行退房");
                    return;
                }

                if(approveResult=="1"&&("${reaudit}"=="0" || "${reaudit}"=="2")){
                    if(sqrq.length!=0){
                        mesData.sqrq=sqrq;
