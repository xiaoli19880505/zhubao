...
<div data-options="region:'center',border:false">
	...
	<div class="easyui-panel resPanel" style="width: 100%;height: 98%;overflow: auto;position: relative">
		<div class="applyContainer">
			<div class="applyTitle"><span>公共租赁住房（低保、特困家庭）申请</span></div>
					...
					<div id="inner">
						<div>
							...
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									...
									<input type="checkbox" name="apTsjt" value="2" disabled/>二级以上下肢重度残疾
								</li>
							</ul>
							<ul class="apply-group windowInner">
								<legend>配偶信息</legend>
							...
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="apSqhjnx" style="width: 92%"
										   data-options="label:'户籍年限(年):',readonly:true">
								</li>
								<li class="readonly">
						...
						<div style="display: none;"  >
							<ul class="apply-group windowInner" >
								...
								<li class="readonly">
									<input class="easyui-combobox" name="applyFamilyHouses[0].afhZfxz" id="applyFamilyHouses0afhZfxz" style="width: 92%" data-options="label:'现住房性质:',readonly:true,
							...
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyHouseChange.afhcYzfzl" id="applyFamilyHouseChangeafhcYzfzl" style="width: 92%"
										   data-options="label:'原住房坐落:',readonly:true">
								</li>
								<li class="readonly">
								...
								<li class="readonly">
									...
									<input type="radio" name="applyFamilyHouseChange.afhcBgfs" value="转让" disabled/>转让 (时间)
								...
								<li id="qc" class="readonly">
									<input class="easyui-textbox" name="applyFamilyHouseChange.afhcZrbcje" id="applyFamilyHouseChangeafhcZrbcje" style="width: 92%"
										   data-options="label:'货币补偿金额(元):',readonly:true">
								</li>
							</ul>
						</div>
						<div style="display: none;">
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfzl" id="applyFamilyHouseChangeafhcAzfzl" style="width: 92%"
										   data-options="label:'安置房坐落:',readonly:true">
								</li>
								<li class="readonly">
							...
							<ul class="apply-group windowInner">
								<legend>低保信息</legend>
								<li class="readonly">
									<input class="easyui-textbox" name="apDbzbh" style="width: 92%" data-options="label:'低保证编号:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="apLqrs" style="width: 92%" data-options="label:'低保领取人数:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-datebox" name="apFzsj" style="width: 92%" data-options="label:'低保发证时间',readonly:true">
								</li>
							</ul>
						</div>
...
<div data-options="region:'south',border:false">
	<div class="auditRestlt">
		...
		<div class="signatureparent" style="display: none">
			<label class="textbox-label textbox-label-before" style="text-align: left; height: 100px;">签字区域:</label>
    ...
    function submit(){
        ...
        if(flag){
            ...
            if(approveResult.length>0&&comment.length>0){
                if(approveResult=="1" && "${butieExt}"=="1"){
                    flag=true;
                    bank.alertMessage("申请用户享有低保特困补贴，请通知走补贴退单程序");
                    return;
                }
