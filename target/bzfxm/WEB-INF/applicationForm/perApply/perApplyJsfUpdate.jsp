                ...
                <div style="display: none;">
                    <table id="table" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                        ...
                        <tr>
                            ...
                            <td class="addJpg">
                                <div>
                                    <div class="fileMark3 filePicker" onclick="add(3);"></div>
                                    <!--用来存放item-->
                        ...
                        <tr>
                            ...
                            <td class="addJpg">
                                <div>
                                    <div class="fileMark4 filePicker" onclick="add(4);"></div>
                                    <!--用来存放item-->
                        ...
                        <tr>
                            ...
                            <td class="addJpg">
                                <div>
                                    <div class="fileMark5  filePicker " onclick="add(5);"></div>
                                    <!--用来存放item-->
                        ...
                        <tr>
                            ...
                            <td class="addJpg">
                                <div>
                                    <div class="fileMark6 filePicker" onclick="add(6);"></div>
                                    <!--用来存放item-->
                        ...
                        <tr>
                            ...
                            <td class="addJpg">
                                <div>
                                    <div class="fileMark7  filePicker" onclick="add(7);"></div>
                                    <!--用来存放item-->
                        ...
                        <tr>
                            ...
                            <td class="addJpg">
                                <div>
                                    <div class="fileMark8  filePicker" onclick="add(8)"></div>
                                    <!--用来存放item-->
                        ...
                        <tr>
                            ...
                            <td class="addJpg">
                                <div>
                                    <div class="fileMark9  filePicker" onclick="add(9)"></div>
                                    <!--用来存放item-->
...
<script>
    var person=false;var i=1;//设置人口情况未1；
    var j=0,sucIndex=0,currentIndex=0,num = "",applyid="",codeArray=[],nameArray=[],initArray=[],idArray=[],sendArray=[];
