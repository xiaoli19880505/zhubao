            ...
            <div id="inner">
                <div>
                    ...
                    <ul class="input-group windowInner">
                        <legend>户籍信息</legend>
                        <li>
                            <input class="easyui-textbox" name="apSqhjnx" style="width: 92%" data-options="label:'户籍年限(年)',required:true,validType:['empty','numberZ','limitHJ[5]']">
                        </li>
                        <li class="readonly">
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox" name="apJtrk" id="apJtrk" style="width: 92%" value="1" data-options="label:'家庭人口:',required:true,validType:'number',readonly:true">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="apRjysr" id="apRjysr" style="width: 92%" data-options="label:'人均月收入(元):',required:true,readonly:true,validType:'number'">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                ...
                <div style="display: none;">
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-combobox" name="applyFamilyHouses[0].afhZfxz" id="applyFamilyHouses0afhZfxz" style="width: 92%" data-options="label:'现住房性质:',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=01',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                    ...
                    <ul class="input-group windowInner" style="display: none" id="cqaz">
                        <legend>安置信息</legend>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfzl"  id="applyFamilyHouseChangeafhcAzfzl" style="width: 92%" data-options="label:'安置房地址:'">
                        </li>
                        <li>
