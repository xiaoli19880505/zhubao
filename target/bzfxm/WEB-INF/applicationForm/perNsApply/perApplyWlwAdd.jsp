...
<div data-options="region:'center'" id="center">
    <span class="top-title">公共租赁住房（外来务工人员）年审申请</span>
    <div id="top">
        <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
            <ul class="input-group">
                ...
                <li>
                    <input class="easyui-combobox" name="apJdbsc" id="apJdbsc" style="width: 92%" data-options="label:'单位所在街道办事处:',required:true,valueField:'piItemcode',textField:'piItemname',
            ...
            <div id="inner">
                <div>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-datebox" name="affLdhtkssj" style="width: 92%" data-options="label:'劳动合同签订年限:',required:true,editable:false,validType:['minDate','annual']">
                        </li>
                        <li>
                ...
                <div style="display: none;">
                    <ul class="input-group windowInner">
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox" name="apJtrk" id="apJtrk" style="width: 92%" value="1" data-options="label:'家庭人口:',readonly:true,required:true,validType:'numberZ'">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="apJtnsr" id="apJtnsr" style="width: 92%" data-options="label:'家庭年收入(元):',readonly:true,validType:['empty','number']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="apRjysr" id="apRjysr" style="width: 92%" data-options="label:'人均月收入(元):',readonly:true,validType:['empty','number']">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
...
<script>
    ...
    var j=0,currentIndex=0 ,sucIndex=0,num ="",codeArray=[],nameArray=[],idArray=[],sendArray=[];
    ...
    function addPerson() {
        ...
        if (person) {
            ...
            var personString = $('<ul class="input-group windowInner">' +
                ...
                '</li>' +
                '<li class="readonly">' +
                '<input class="easyui-datebox" name="applyFamilyMembers[' + addIndex + '].afmCsny" id="applyFamilyMembers' + addIndex + 'afmCsny" style="width: 92%" data-options="label:\'出生年月:\',required:true,editable:false">' +
                '</li>' +
                '<li class="readonly">' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex + '].afmGzdw" style="width: 92%" data-options="label:\'工作单位:\',required:true,prompt:\'请输入单位全称\',validType:[\'empty\']">' +
                '</li>' +
                '<li>' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex+ '].afmNsr" id="applyFamilyMembers' + addIndex + 'afmNsr" style="width: 92%" data-options="label:\'年收入:\',required:true,validType:\'number\',events:{keyup:changeSr}">' +
                '</li>' +
                '</ul>').appendTo("#addPerson");
            $.parser.parse(personString);
            changeMj(i);
            changeSr(i)
        } else {
