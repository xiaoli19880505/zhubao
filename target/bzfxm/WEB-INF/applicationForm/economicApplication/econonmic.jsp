...
<body class="easyui-layout" onbeforeunload="bank.removeChart()"  onunload="bank.removeChart()">
    ...
    <div id="top">
        <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
            <ul class="input-group">
                  ...
                  <li>
                      <input class="easyui-combobox" name="apJdbsc" id="apJdbsc" style="width: 92%" data-options="label:'户籍所在街道办事处:',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=06',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                  </li>
                  <li>
            ...
            <div id="inner">
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li >
                            <select class="easyui-combobox" name="applyFamilyMembers[0].afmHyzk" id="applyFamilyMembers0afmHyzk" style="width: 92%"
                                   data-options="label:'婚姻状况:',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=07',valueField:'piItemcode',textField:'piItemname',editable:false,required:true,panelHeight:'auto',onSelect:selecthyzk">
                            </select>
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmGzdw" style="width: 92%" data-options="label:'工作单位:',prompt:'请输入单位全称',required:true">
                        </li>
                        <li class="readonly">
                ...
                <div style="display: none;">
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouses[0].afhZl" style="width: 92%" data-options="label:'房屋地址:',required:true,validType:['empty']">
                        </li>
                        <li>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcYzfzl" style="width: 92%" data-options="label:'原住房地址:'">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcCqr" style="width: 92%" data-options="label:'原产权人:',validType:['chinese','specialCharacter']">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcJzmj" style="width: 92%" data-options="label:'建筑面积(m²):',validType:['number']">
                        </li>
                        <li>
                ...
                <div style="display: none;">
                    <table id="table" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                        ...
                        <tr>
                            ...
                            <td class="addJpg">
                                <div>
                                    <div class="fileMark0 filePicker" onclick="add(0)"></div>
                                    <!--用来存放item-->
                        ...
                        <tr>
                            ...
                            <td class="addJpg">
                                <div>
                                    <div class="fileMark1 filePicker" onclick="add(1)"></div>
                                    <!--用来存放item-->
                        ...
                        <tr>
                            ...
                            <td class="addJpg">
                                <div>
                                    <div class="fileMark2 filePicker" onclick="add(2)"></div>
                                    <!--用来存放item-->
    ...
    function addPerson() {
        ...
        if(person){
            ...
            var perString=$('<ul class="input-group windowInner">' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex + '].afmSfzh" id="applyFamilyMembers' + addIndex + 'afmSfzh" style="width: 92%" data-options="label:\'身份证号:\',required:true,validType:[\'sfz\',\'empty\'],events:{keyup:setBirthday}">' +
                '</li>' +
                '<li>' +
