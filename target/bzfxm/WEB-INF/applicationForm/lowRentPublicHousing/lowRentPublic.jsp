            ...
            <div id="inner">
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <label style="width: 130px;display: inline-block;float: left;margin-left: -3px;text-align:center">是否特殊家庭:</label>
                            <input type="checkbox" value="2" id="apTsjt" style="margin-left: -28px"/>二级以上下肢重度残疾
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        <legend>配偶信息</legend>
