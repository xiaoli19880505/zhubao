            ...
            <div class="mui-scroll">
                <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
                    ...
                    <div id="wrap2" style="display: none;">
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="afgDwmc" data-options="label:'单位名称',required:true,prompt:'请输入单位全称',validType:['empty']">
                                    </div>
                                    <div class="commonRow">
                        ...
                        <div class="mui-card">
                                ...
                                <div class="mui-input-group">
                                    <div class="readonlyRow commonRow">
                                        ...
                                        <div class="commonRow readonlyRow">
                                            <input class="easyui-textbox" name="afgGrnsr" id="applyFamilyMembers0afmNsr"
                            ...
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="afgHjdz"
                                               data-options="label:'户籍地址',required:true,validType:['checkHj','empty']">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="afgSqhjnx"
                                               data-options="label:'户籍年限(年)',required:true,validType:['numberZ','empty']">
                                    </div>
                                    <div class="commonRow readonlyRow">
                                        <input class="easyui-textbox" name="afgJtrks" id="afgJtrks" value="1"
                                               data-options="label:'家庭人口',required:true,readonly:true,validType:['numberZ','empty']">
                                    </div>
                                    <div class="commonRow readonlyRow">
                                        <input class="easyui-textbox" name="afgJtnsr" id="afgJtnsr"
                                               data-options="label:'家庭年收入(元)',readonly:true,required:true,validType:['number','empty']">
                                    </div>
                                    <div class="commonRow readonlyRow">
                                        <input class="easyui-textbox" name="afgRjysr" id="afgRjysr"
                                               data-options="label:'人均月收入(元)',readonly:true,required:true,validType:['number','empty']">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyUnit.entag"
                                               data-options="label:'委托代理人',validType:['empty','chinese','specialCharacter']">
                                    </div>
                                    <div class="commonRow">
                    ...
                    <div id="wrap3" style="display: none;">
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    <div class="commonRow">
                                        <input class="easyui-datebox" name="afgLdhtkssj"
                                               data-options="label:'劳动合同签订年限',required:true,editable:false,validType:['minDate']">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-datebox" name="afgLdhtjssj"
                                               data-options="label:'至',required:true,editable:false">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-datebox" name="afgSbjnsj"
                                               data-options="label:'社会保险缴纳情况',required:true,editable:false,validType:['minDate','annual']">至今
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-datebox" name="afgGjjjnsj"
                                               data-options="label:'住房公积金缴纳情况',editable:false,validType:['minDate']">至今
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mui-input-group">
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyFamilyHouses[0].afhZl"
                                               data-options="label:'房屋地址',required:true">
                                    </div>
                                    <div class="commonRow">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyFamilyHouses[0].afhMj"
                                               id="applyFamilyHouses0afhMj"
                                               data-options="label:'房屋面积(m²)',required:true,validType:'empty',events:{keyup:changeMj}">
                                    </div>
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="applyFamilyHouses[0].afhRjmj"
                                               id="applyFamilyHouses0afhRjmj"
                                               data-options="label:'人均建筑面积(m²)',required:true,validType:'number',readonly:true">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-combobox" name="applyFamilyHouses[0].afhZfxz"
                                               data-options="label:'现住房性质',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=01',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="wrap5" style="display: none;">
                        ...
                        <div class="mui-card">
                            <!--页眉，放置标题-->
                            <div class="mui-card-header"><span></span><span class="name">收入情况证明材料</span><span class="reqSpan">*(必填)</span><span id="type0" class="detail">详情</span></div>
                            <!--内容区-->
                            <div class="mui-card-content">
