				...
				<div class="mui-scroll">
					<form method="post" id="form" class="easyui-form" enctype="multipart/form-data" >
						...
						<div id="wrap1">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div style="display: none">
											<input class="easyui-textbox" name="abId" id="abId">
										</div>
										<div class="commonRow">
											<input class="easyui-combobox" name="abSsq"  data-options="label:'户籍所在区(县)',required:true,valueField:'piItemcode',textField:'piItemname',
                                        url:'<%=basePath %>ParmItem/selectSsqExceptCenter',onSelect:selectSSQ,editable:false,panelHeight:'auto',panelMaxHeight:'280'">
										</div>
										<div class="commonRow">
											<input class="easyui-combobox" name="abJdbsc" id="abJdbsc"   data-options="label:'户籍所在街道办事处',required:true,valueField:'piItemcode',textField:'piItemname',
							...
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow">
											<input class="easyui-textbox" name="abSqhjnx"  data-options="label:'户籍年限(年)',required:true,required:true,validType:['empty','numberZ','limitHJ[5]']">
										</div>
										<div class="commonRow readonlyRow">
										...
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="abJtrk" id="abJtrk"   data-options="label:'家庭人口',readonly:true,required:true,validType:['numberZ','empty']">
										</div>
										<div class="commonRow readonlyRow">
						...
						<div id="wrap2" style="display: none;">
							...
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow">
											<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfzl" id="applyFamilyHouseChangeafhcAzfzl"  data-options="label:'安置房地址',validType:['empty']">
										</div>
										<div class="commonRow">
							...
							<div class="mui-card">
								...
								<div class="mui-card-content">
									<div class="mui-input-group">
										<div class="commonRow">
											<input class="easyui-textbox" name="abDbzbh" id="abDbzbh" data-options="label:'低保/特困证编号',required:true,validType:['empty']">
										</div>
										<div class="commonRow">
											<input class="easyui-textbox" name="abLqrs" id="abLqrs" data-options="label:'低保/特困领取人数',required:true,validType:['numberZ','empty']">
										</div>
										<div class="commonRow">
											<input class="easyui-datebox" name="abFzsj" id="abFzsj" data-options="label:'低保/特困发证时间',required:true,editable:false,validType:['minDate','dbAnnual']">
										</div>
									</div>
								</div>
							</div>
						...
						<div id="wrap4" style="display: none;">
							...
							<div class="mui-card">
								<!--页眉，放置标题-->
								<div class="mui-card-header"><span><span class="name">特殊情况证明</span><span class="red">*(必填)</span></span><span id="type3" class="detail">详情</span></div>
								<!--内容区-->
								<div class="mui-card-content">
...
<script>
    ...
    var j=0,sucIndex=0,currentIndex=0,applyid="",codeArray=[],nameArray = [],initArray=[],idArray=[],sendArray=[];
    ...
    function secondSave() {
        ...
        $('#form').form('submit', {
            url: '<%=basePath %>applyButie/updateApplyButieInfo',
    ...
    function setSign(data){
        if(data.abBaseimg!=undefined){
            initSign=data.abBaseimg;
        }else{
