								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										...
										<div class="commonRow readonlyRow">
											...
											<input type="checkbox" name="apTsjt" value="2" disabled/><label class="lispan">二级以上下肢重度残疾</label>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										...
										<div class="commonRow readonlyRow">
											<input class="easyui-combobox" name="applyFamilyHouses[0].afhZfxz" id="applyFamilyHouses0afhZfxz"  data-options="label:'现住房性质',readonly:true,
									valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=01'">
										</div>
									</div>
								</div>
							</div>
						...
						<div id="wrap3" style="display: none;">
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfzl" id="applyFamilyHouseChangeafhcAzfzl"  data-options="label:'安置房坐落',readonly:true">
										</div>
										<div class="commonRow readonlyRow">
