			...
			<div class="mui-scroll">
				<form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
						...
						<div class="mui-card">
							...
							<div class="mui-card-content">
								<div class="mui-row" style="padding:5px">
									根据《徐州市市区公共租赁住房租赁补贴实施细则》徐住保办发[2017]6号）的有关规定，现将本市公共租赁住房租赁补贴申请有关事项告知如下：
								</div>
								<div class="mui-row" style="padding:5px">一、徐州市公共租赁住房租赁补贴保障范围</div>
								<div class="mui-row" style="padding:5px">
									徐州市市区公共租赁住房租赁补贴主要面向在市区（鼓楼区、云龙区、泉山区、经济技术开发区）范围内符合条件的低保、特困、低收入家庭。
								</div>
								...
								<div class="mui-row" style="padding:5px">
									2.家庭人均月收入低于1549元（低保特困家庭需连续享受城市最低生活保障或持有市总工会核发的《特困职工证》一年以上）；
								</div>
								...
								<div class="mui-row" style="padding:5px">
									2、收入情况的证明材料（有单位的由单位出具证明【6个月以上单位发放工资的银行流水单】，无单位的由社区出具证明。在法定劳动年龄内并有劳动能力的申请人，本人不能提供收入证明的，以及单位出具收入证明低于上年度市区最低工资标准或无法计算的，均按照市区上年度最低工资标准计算收入）；
								</div>
								<div class="mui-row" style="padding:5px">
									3、住房状况的证明材料（包括不动产证、产权证、他项权证、公房租约、5年内已转让和已领取拆迁补偿款房屋、已签订合同尚未交付房屋等相关资料，无房的出具无房证明）；
								</div>
								<div class="mui-row" style="padding:5px">4、家庭成员身份证和户口簿
									；申请家庭委托代理人的，须提供申请家庭的书面《委托书》及代理人的身份证件；
								</div>
								...
								<div class="mui-row" style="padding:5px">
									1、申请人向户口所在地的区街道办事处住房保障服务窗口提出申请，住保窗口同时组织所辖社区居委会对申请人递交的材料进行初审，并就家庭有关情况进行调查确认，对是否符合规定条件提出审核意见，并在社区进行公示，公示期限为10天。经公示无异议或者异议不成立的，申请人登录徐州市住房保障系统，按系统提示要求进行注册、填写资料、提交上传各项证明资料（原件拍照后上传）。
								</div>
								<div class="mui-row" style="padding:5px">
									2、申请人户口所在地的办事处住保窗口工作人员凭账号和密码登录徐州市住房保障系统，对申请人提交的资料进行本级审核，3个工作日内完成对申请人提交的材料及有关情况的调查核实。审核通过的，在审核系统上签署审核通过意见并签字；对审核不通过的，审核人填写初审不通过原因，由审核系统向申请人发送短信告知本人。
								</div>
								<div class="mui-row" style="padding:5px">
									3、区民政部门工作人员凭账号和密码登录徐州市住房保障系统，对经办事处住保窗口审核通过的申请人提交的资料进行收入审核，审核通过的，在审核系统上签署审核通过意见并签字。区民政部门
									3个工作日内完成本级审核工作。
								</div>
								<div class="mui-row" style="padding:5px">
									4、区住保部门工作人员凭账号和密码登录徐州市住房保障系统，对经区民政部门审核通过的申请人提交的资料进行本级审核，由系统向申请人发送短信告知其审核申请资料原件的时间、地点、；审核通过的，审核人在审核系统上签署审核通过意见并签字,由审核系统向申请人发送审核通过短信；审核不通过的，审核人填写复审不通过原因，由审核系统向申请人发送短信告知本人。区住保部门
									4个工作日内完成本级审核工作。
								</div>
								<div class="mui-row" style="padding:5px">
									5、市住保中心工作人员凭账号和密码登录徐州市住房保障系统，对经各区审核通过的申请人提交的资料进行本级审核。审核通过的，审核人在审核系统上签署审核通过意见并签字，由审核系统向申请人发送审核通过的短信，市住保中心在市住房保障和房产管理局政务网、市政府政务网公告公示栏目上公示10天，期间接受举报和举证，并组织复查。公示无异议及调查核实后符合条件的家庭，由市住房保障服务中心进行备案，确认为租赁补贴发放对象。审核不通过的，审核人填写审核不通过原因，由审核系统向申请人发送短信告知本人。市住保中心5个工作日（不含公示期）内完成本级审核工作
								</div>
								...
								<div class="mui-row" style="padding:5px">
									1、公共租赁住房租赁补贴保障有效期为一年，按年度进行审核，补贴协议一年一签。保障家庭应在保障有效期届满前30天内，向市住房保障服务中心提交相关材料进行资格年审。经年审符合条件的，可继续按规定申领补贴；年审不符合条件的，补贴保障终止；未按规定进行资格审核的，视为自愿放弃租赁补贴资格，将停发租赁补贴。
								</div>
								<div class="mui-row" style="padding:5px">
									2、对按规定申报家庭人口、收入、住房变化情况的家庭，市、区住保部门审核其租赁补贴资格和租赁补贴额度，对不再符合租赁补贴条件的家庭，自不符合条件当月起停发租房补贴；对需调整补贴额的家庭，自申报次月起调整租房补贴的补贴额度。
								</div>
								<div class="mui-row" style="padding:5px">
									3、对未按规定进行年度申报的家庭，市住房保障服务中心自该家庭享受租赁补贴期满次月起停发补贴；享受租赁补贴的家庭补报本年度家庭变化情况，并经审核，符合享受租赁补贴条件的，自审核合格的次月起恢复发放租房补贴，但停发期间租赁补贴不予补发。
								</div>
								<div class="mui-row" style="padding:5px">
									4、对经核查不符合公共租赁房租赁补贴条件的家庭，自发现不符合条件次月起停发租房补贴；对需调整补贴额的家庭，自核查次月起调整租房补贴的补贴额度。
								</div>
								<div class="mui-row" style="padding:5px">
									5、对申请家庭自行购房、中断租赁关系、自愿退出的，市住房保障服务中心通知申请人自复核次月起停发租房补贴。自愿退出租房补贴的家庭，需到市住房保障服务中心办理退出手续。
								</div>
								<div class="mui-row" style="padding:5px">
									6、对于原申请人已故且该家庭仍符合租房补贴条件的，由申请家庭共同推荐的申请人到市住房保障服务中心办理租赁补贴变更手续后，可由变更后的申请人继续领取租房补贴。
								</div>
								<div class="mui-row" style="padding:5px">
									七、其他未尽事项，以《徐州市市区公共租赁住房租赁补贴实施细则》徐住保办发[2017]6号）相关规定为准，申请前请详细阅读相关政策。
								</div>
						...
						<div class="mui-card">
							...
							<div class="mui-card-content">
								<div class="mui-input-group">
									<div class=commonRow>
										<input class="easyui-combobox" name="apSsq" data-options="label:'户籍所在区（县）',required:true,valueField:'piItemcode',textField:'piItemname',
										url:'<%=basePath %>ParmItem/selectSsqExceptCenter',onSelect:selectSSQ,editable:false,panelHeight:'auto',panelMaxHeight:'280'">
									</div>
									<div class=commonRow>
										<input class="easyui-combobox" name="apJdbsc" id="apJdbsc" data-options="label:'户籍所在街道办事处',required:true,valueField:'piItemcode',textField:'piItemname',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
									</div>
									<div class=commonRow>
						...
						<div class="mui-card">
							...
							<div class="mui-card-content">
								<div class="mui-input-group">
									...
									<div class="commonRow">
										...
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="applyFamilyMembers[0].afmLxdh" value="${sessionScope.applyUserinfo.linktel}" data-options="label:'联系电话',required:true,validType:'phone',readonly:true">
										</div>
										<div class="commonRow">
							...
							<div class="mui-card">
								...
								<div class="mui-card-content">
									<div class="mui-input-group">
										...
										<div class="commonRow">
											<input class="easyui-textbox" name="applyFamilyMembers[1].afmGzdw" id="applyFamilyMembers1afmGzdw" data-options="label:'工作单位',required:true,prompt:'请输入单位全称'">
										</div>
										<div class="commonRow">
							...
							<div class="mui-card">
								...
								<div class="mui-card-content">
									<div class="mui-input-group">
										<div class="commonRow">
											<input class="easyui-textbox" name="apSqhjnx" data-options="label:'户籍年限(年)',required:true,validType:['empty','numberZ','limitHJ[5]']">
										</div>
										<div class="commonRow readonlyRow">
										...
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="apJtrk" id="apJtrk" value="1" data-options="label:'家庭人口',required:true,validType:'number',readonly:true">
										</div>
										<div class="commonRow readonlyRow">
					...
					<div id="wrap3" style="display: none;">
						<div class="mui-card">
							...
							<div class="mui-card-content">
								<div class="mui-input-group">
									<div class="commonRow">
										<input class="easyui-textbox" name="applyFamilyHouses[0].afhZl" data-options="label:'房屋地址',required:true">
									</div>
									<div class="commonRow">
									...
									<div class="commonRow readonyRow">
									...
									<div class="commonRow">
										<input class="easyui-combobox" name="applyFamilyHouses[0].afhZfxz" id="applyFamilyHouses0afhZfxz" data-options="label:'现住房性质',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=01',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
									</div>
								</div>
							</div>
						</div>
						<div class="mui-card">
							...
							<div class="mui-card-content">
								<div class="mui-input-group">
									<div class="commonRow">
										<input class="easyui-textbox" name="applyFamilyHouseChange.afhcYzfzl" data-options="label:'原住房地址',validType:['empty']">
									</div>
									<div class="commonRow">
										<input class="easyui-textbox" name="applyFamilyHouseChange.afhcCqr" data-options="label:'原产权人',validType:['empty','chinese','specialCharacter']">
									</div>
									<div class="commonRow">
										<input class="easyui-textbox" name="applyFamilyHouseChange.afhcJzmj" data-options="label:'建筑面积(m²)',validType:['number','empty']">
									</div>
									<div class="commonRow">
						...
						<div class="mui-card">
							...
							<div class="mui-card-content">
								<div class="mui-input-group">
									...
									<div class="commonRow">
										<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfjzmj" id="applyFamilyHouseChangeafhcAzfjzmj" data-options="label:'建筑面积(m²)',validType:['number','empty']">
									</div>
								</div>
							</div>
						</div>
						<div class="mui-card">
							...
							<div class="mui-card-content">
								<div class="mui-input-group">
									<div class="commonRow">
										<input class="easyui-textbox" name="apDbzbh" data-options="label:'低保/特困证编号',required:true">
									</div>
									<div class="commonRow">
										<input class="easyui-textbox" name="apLqrs" data-options="label:'低保/特困领取人数',required:true,validType:['numberZ','empty']">
									</div>
									<div class="commonRow">
										<input class="easyui-datebox" name="apFzsj" data-options="label:'低保/特困发证时间',required:true,editable:false,validType:['minDate','dbAnnual']">
									</div>
								</div>
							</div>
						</div>
					...
					<div id="wrap5" style="display: none;">
						<div class="mui-card">
							<!--页眉，放置标题-->
							<div class="mui-card-header"><span><span class="name">收入情况证明材料</span><span class="reqSpan">*(必填)</span></span><span id="type0" class="detail">详情</span>
							</div>
							<!--内容区-->
							<div class="mui-card-content">
						...
						<div class="mui-card">
							<!--页眉，放置标题-->
							<div class="mui-card-header"><span><span class="name">家庭成员身份证</span><span class="reqSpan">*(必填)</span></span>
							</div>
							<!--内容区-->
							<div class="mui-card-content">
						...
						<div class="mui-card">
							<!--页眉，放置标题-->
							<div class="mui-card-header"><span class="name">合法有效家庭成员之间的赡养、抚养、扶养关系及共同生活的证明</span>
							</div>
							<!--内容区-->
							<div class="mui-card-content">
						...
						<div class="mui-card">
							<!--页眉，放置标题-->
							<div class="mui-card-header"><span><span class="name">申请人申报财产真实性书面承诺</span><span class="reqSpan">*(必填)</span></span>
							</div>
							<!--内容区-->
							<div class="mui-card-content">
...
<script>
    mui.init();
    var person = false;var i=1;//婚姻状况是否可添加家庭成员
    ...
    mui(".mui-card").on('tap', '.greenPan', function (e) {
        ...
        if (person) {
            ...
            var perString = $('<div class="mui-card">' +
                ...
                '            </div>' +
                '            <div class="commonRow">' +
                '                <input class="easyui-textbox" name="applyFamilyMembers[' + addIndex+ '].afmNsr" id="applyFamilyMembers' + addIndex + 'afmNsr"  value="0"  data-options="label:\'年收入(元)\',required:true,validType:[\'number\',\'empty\'],events:{keyup:changeSr}">' +
                '            </div>' +
                '       </div>' +
                '     </div>' +
