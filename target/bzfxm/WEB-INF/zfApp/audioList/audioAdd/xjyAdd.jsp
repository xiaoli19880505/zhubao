					...
					<div id="wrap0">
						<div class="mui-card">
							...
							<div class="mui-card-content" >
								<div class="mui-row" style="padding:5px">根据《徐州市市区公共租赁住房管理办法》徐政规[2012]8号）的有关规定，现将本市公共租赁住房申请有关事项告知如下：</div>
								<div class="mui-row" style="padding:5px">一、徐州市市区公共租赁住房保障范围</div>
								<div class="mui-row" style="padding:5px">徐州市市区公共租赁住房主要面向在市区（鼓楼区、云龙区、泉山区、经济技术开发区）范围内稳定就业的新就业人员和外来务工人员。</div>
								...
								<div class="mui-row" style="padding:5px">（6）本人及配偶、未成年子女在市区无住房、商铺、写字楼（包括已签订合同未取得不动产登记证的房屋），未租住公有住房。</div>
								...
								<div class="mui-row" style="padding:5px">（4）本人及配偶、未成年子女在市区无住房、商铺、写字楼（包括已签订合同未取得不动产登记证的房屋），未租住公有住房；</div>
								...
								<div class="mui-row" style="padding:5px">1、申请人向用工单位提出申请， 用工单位对申请人提交的材料进行审核并公示10天。经公示无异议或者异议不成立的，申请人登录徐州市住房保障系统，按系统提示要求进行注册、填写资料、提交上传各项证明资料（原件拍照后上传）。 </div>
								<div class="mui-row" style="padding:5px">2、申请人单位所在地的办事处住保窗口工作人员凭账号和密码登录徐州市住房保障系统，对申请人提交的资料进行本级审核，5个工作日内完成对申请人提交的材料及有关情况的调查核实。审核通过的，在审核系统上签署审核通过意见并签字；对审核不通过的，审核人填写初审不通过原因，由审核系统向申请人发送短信告知本人。 </div>
								<div class="mui-row" style="padding:5px">3、区住保部门工作人员凭账号和密码登录徐州市住房保障系统，对经办事处住保窗口审核通过的申请人提交的资料进行本级审核，由系统向申请人发送短信告知其审核申请资料原件的时间、地点、；审核通过的，审核人在审核系统上签署审核通过意见并签字, 由审核系统向申请人发送审核通过短信；审核不通过的，审核人填写审核不通过原因，由审核系统向申请人发送短信告知本人。区住保部门 5个工作日内完成本级审核工作。</div>
								<div class="mui-row" style="padding:5px">4、市住保中心工作人员凭账号和密码登录徐州市住房保障系统，对经各区审核通过的申请人提交的资料进行本级审核。审核通过的，审核人在审核系统上签署审核通过意见并签字，由审核系统向申请人发送审核通过的短信，市住保中心在市住房保障和房产管理局政务网、市政府政务网公告公示栏目上公示10天，期间接受举报和举证，并组织复查。公示无异议及调查核实后符合条件的家庭，由市住房保障服务中心进行备案，确认为配租对象并进行房源分配。审核不通过的，审核人填写审核不通过原因，由审核系统向申请人发送短信告知本人。市住保中心 5个工作日（不含公示期）内完成本级审核工作。</div>
								<div class="mui-row" style="padding:5px">五、公共租赁住房租金及物业服务费标准</div>
								<div class="mui-row" style="padding:5px">徐州市市区公共租赁住房成套住宅按建筑面积计算租金，租金标准为5.6元/㎡/月；公寓住房按套计算租金，租金标准为200元/套/月。</div>
								...
								<div class="mui-row" style="padding:5px">公共租赁住房承租人有下列情形之一的，住房保障部门有权解除租赁合同，收回公共租赁住房，将其行为记入个人信用档案：</div>
								...
								<div class="mui-row" style="padding:5px">七、其他未尽事项，以《徐州市市区公共租赁住房管理办法》徐政规[2012]8号）相关规定为准，申请前请详细阅读相关政策。</div>
						...
						<div class="mui-card">
							...
							<div class="mui-card-content" >
								<div class="mui-input-group">
									...
									<div class="commonRow">
										<input class="easyui-combobox" name="apJdbsc" id="apJdbsc"  data-options="label:'街道办事处',required:true,valueField:'piItemcode',textField:'piItemname',
						...
						<div class="mui-card">
							...
							<div class="mui-card-content" >
								<div class="mui-input-group">
									...
									<div class="commonRow readonlyRow">
										<input class="easyui-textbox" name="applyFamilyMembers[0].afmLxdh" value="${sessionScope.applyUserinfo.linktel}"  data-options="label:'联系电话',required:true,readonly:true,validType:'phone'">
									</div>
									<div class="commonRow readonlyRow">
										<input class="easyui-textbox" name="applyFamilyMembers[0].afmSfzh"  id="applyFamilyMembers0afmSfzh" value="${sessionScope.applyUserinfo.sfzh}"  data-options="label:'身份证号码',required:true,readonly:true,validType:['sfz','empty']">
									</div>
									<div class="commonRow">
									...
									<div class="commonRow">
										<input class="easyui-combobox" name="applyFamilyMembers[0].afmHyzk" id="applyFamilyMembers0afmHyzk" data-options="label:'婚姻状况',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=07',
						...
						<div class="mui-card">
							...
							<div class="mui-card-content" >
								<div class="mui-input-group">
									...
									<div class="commonRow readonlyRow">
										<input class="easyui-textbox" name="apJtrk" id="apJtrk" value="1"  data-options="label:'家庭人口',readonly:true,validType:['numberZ','empty']">
									</div>
									<div class="commonRow readonlyRow">
						...
						<div class="mui-card">
							...
							<div class="mui-card-content" >
								<div class="mui-input-group">
									...
									<div class="commonRow">
										<input class="easyui-textbox" name="applyUnit.bsls"  data-options="label:'统一社会信用代码',required:true,validType:['empty','xyCode']">
									</div>
									<div class="commonRow">
...
<script>
    ...
    function changeSr(obj){
        ...
        if(typeof(obj)=="object"){
            ...
            var oldValue=$.trim($('#'+id+'').textbox('getValue'));
