                            ...
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        ...
                                        <div class="commonRow readonlyRow">
                                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmNsr" id="applyFamilyMembers0afmNsr" data-options="label:'个人年收入(元)',readonly:true,validType:['number','empty']">
                                        </div>
                                    </div>
                                    <div class="commonRow readonlyRow">
                                        <label class="textbox-label textbox-label-before" style="text-align: left; height: 32px; line-height: 10px;">是否特殊家庭</label>
                                        <input type="checkbox" name="apTsjt" value="3" disabled/><label class="lispan">二级以上下肢重度残疾</label>
                                    </div>
                                </div>
                            </div>
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        ...
                                        <div class="commonRow readonlyRow">
                                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmNsr" id="applyFamilyMembers1afmNsr" data-options="label:'个人年收入(元)',readonly:true,validType:['number','empty']">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        ...
                                        <div class="commonRow readonlyRow">
                                            <label class="textbox-label textbox-label-before" style="text-align: left; height: 32px; line-height:
        10px;">方式</label>
                                        ...
                                        <div class="commonRow readonlyRow" id="cqtime">
                                            <input class="easyui-datebox" name="applyFamilyHouseChange.afhcBgsj" id="applyFamilyHouseChangeafhcBgsj" data-options="label:'拆迁时间',required:true,editable:false">
                                        </div>
                                        <div class="commonRow readonlyRow" id="cq">
                                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcZrbcje" id="applyFamilyHouseChangeafhcZrbcje" data-options="label:'货币补偿金额(元)',required:true,validType:'number'">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content" >
                                    <div class="mui-input-group">
                                        <div class="commonRow readonlyRow">
                                            <input class="easyui-textbox"  name="apDbzbh"  data-options="label:'低保/特困证编号',readonly:true">
                                        </div>
                                        <div class="commonRow readonlyRow">
                                            <input class="easyui-textbox" name="apLqrs"  data-options="label:'低保/特困领取人数',readonly:true">
                                        </div>
                                        <div class="commonRow readonlyRow">
                                            <input class="easyui-textbox" name="apFzsj" data-options="label:'低保/特困发证时间',readonly:true">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="wrap4" style="display: none;">
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">收入情况证明材料</span><span id="type0" class="detail">详情</span></div>
                                <!--内容区-->
                                <div class="mui-card-content">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">申请人申报财产真实性书面承诺</span><span
                                        class="red">*(必填)</span></div>
                                <!--内容区-->
                                <div class="mui-card-content">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">婚姻情况证明<span class="reqSpan">*(必填)</span></span><span id="type2" class="detail">详情</span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
