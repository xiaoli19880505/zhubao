                ...
                <div class="mui-scroll">
                    <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
                            ...
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        ...
                                        <div class="readonlyRow commonRow">
                                            <input class="easyui-combobox" name="apSsq" data-options="label:'单位所在区(县)',readonly:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=05'">
                                        </div>
                                        <div class="readonlyRow commonRow">
                                            <input class="easyui-combobox" name="apJdbsc" data-options="label:'单位所在街道办事处',readonly:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=06'">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="wrap2" style="display: none;">
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        <div class="readonlyRow commonRow">
                                            <input class="easyui-textbox" name="apJtrk"
                                                   data-options="label:'家庭人口',readonly:true">
                                        </div>
                                        <div class="readonlyRow commonRow">
                                            <input class="easyui-textbox" name="apJtnsr"
                                                   data-options="label:'家庭年收入(元)',readonly:true">
                                        </div>
                                        <div class="readonlyRow commonRow">
                                            <input class="easyui-textbox" name="apRjysr"
                                                   data-options="label:'人均月收入(元)',readonly:true">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        ...
                                        <div class="readonlyRow commonRow">
                                            <input class="easyui-textbox" name="applyFamilyHouses[0].afhMj" id="applyFamilyHouses0afhMj" data-options="label:'房屋面积(m²)',readonly:true">
                                        </div>
                                        <div class="readonlyRow commonRow">
                        ...
                        <div id="wrap4" style="display: none;">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">户口簿及其他居住证明<span class="reqSpan">*(必填)</span></span><span id="type10" class="detail">详情</span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">劳动合同或者聘用合同<span class="reqSpan">*(必填)</span></span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">收入情况证明材料<span class="reqSpan">*(必填)</span></span><span id="type11" class="detail">详情</span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">住房状况证明材料<span class="reqSpan">*(必填)</span></span><span id="type6" class="detail">详情</span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
