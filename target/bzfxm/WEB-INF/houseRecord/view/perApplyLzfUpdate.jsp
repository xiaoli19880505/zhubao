            ...
            <div id="inner">
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li class="readonly">
                            <select class="easyui-combobox" name="applyFamilyMembers[0].afmXb"  value="${sessionScope.applyUserinfo.sex}" id="applyFamilyMembers0afmXb" style="width: 92%"
