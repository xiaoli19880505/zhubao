	...
	<div class="easyui-panel windowPanel">
		...
		<form method="post" id="form" class="easyui-form">
			<ul class="search-group-add windowInner">
				<legend>基本信息</legend>
				<li style="width: 380px"><input class="easyui-datebox" name="sqrq" id="sqrq" style="width: 92%" data-options="label:'通知时间:',required:true,editable:false,validType:['overDate','empty']"></li>
				<li style="width: 380px"><input class="easyui-textbox" name="doc" id="doc" style="width: 92%;height:80px" data-options="label:'资料名称:',multiline:true,required:true,validType:['empty']"></li>
				<li style="width: 380px"><input class="easyui-textbox" name="area" id="area" style="width: 92%" data-options="label:'办理地点:',required:true,validType:['empty']"></li>
...
<script>
    ...
    $(function () {
        ...
        $("input[name='contents']").prop("checked",true);
        $("#ssq").combobox({
