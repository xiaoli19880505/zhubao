    ...
    <div class="north_center">
        ...
        <c:choose>
            <c:when test="${overTimeMap.csCount!=null and overTimeMap.nsCount!=null}">
                <span class="red" style="float: right"><marquee direction="left" behavior="scroll" scrollamount="1" scrolldelay="0" loop="-1" width="350" height="50" bgcolor="#006BA0" hspace="10" vspace="10">您有${overTimeMap.csCount}条待审批申请单和${overTimeMap.nsCount}条待审批年审单已超时，请及时处理</marquee></span>
            </c:when>
            <c:when test="${overTimeMap.csCount!=null}">
                <span class="red" style="float: right"><marquee direction="left" behavior="scroll" scrollamount="1" scrolldelay="0" loop="-1" width="350" height="50" bgcolor="#006BA0" hspace="10" vspace="10">您有${overTimeMap.csCount}条待审批申请单已超时，请及时处理</marquee></span>
            </c:when>
            <c:when test="${overTimeMap.nsCount!=null}">
                <span class="red" style="float: right"><marquee direction="left" behavior="scroll" scrollamount="1" scrolldelay="0" loop="-1" width="350" height="50" bgcolor="#006BA0" hspace="10" vspace="10">您有${overTimeMap.nsCount}条待审批年审单已超时，请及时处理</marquee></span>
            </c:when>
        </c:choose>
    </div>
