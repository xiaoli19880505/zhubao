    ...
    <div class="regContanier">
        ...
        <div class="regRight">
            ...
            <form class="changeForm" id="ff" method="post" >
                ...
                <div class="formItem">
                    <input class="easyui-textbox" id="userpwd"  name="userpwd" type="password"  style="width: 82%" data-options="label:'<i style=\'color:red\'>* </i>密码:',required:true,validType:['empty','checkLength[6,20]']" >
                </div>
                <div class="formItem">
...
<script>
    ...
    function save(){
        bank.ajaxForm('#ff','<%=basePath %>applyUserinfo/insertUserInfo', {}, function(data){
            if(data=="注册成功"){
                bank.alertMessage('注册信息已提交，请到所在地街道办事处住保科进行帐号激活');
                setTimeout(function () {
                    window.location.href = '<%=basePath %>/pageColumn/external/h_index'
                },5000)
                }else{
            ...
            if(linktel.length==0){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        bank.ajaxMessage("获取验证码成功，请查看手机短信")
                       // $(".code").html("");
                    },error:function(){
