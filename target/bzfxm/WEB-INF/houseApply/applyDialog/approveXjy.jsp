...
<div data-options="region:'center',border:false">
	...
	<div class="easyui-panel resPanel" style="width: 100%;height: 98%;overflow: auto;position: relative">
		<div class="applyContainer">
			<div class="applyTitle"><span>公共租赁住房（新就业人员）申请</span></div>
			<div class="applyContent">
				<form method="post" id="form" class="easyui-form">
					<ul class="apply-group windowInner">
						<li class="readonly">
							<input class="easyui-textbox" name="afgDwmc" style="width: 92%" data-options="label:'单位名称:',readonly:true">
						</li>
						<li class="readonly">
							<input class="easyui-combobox" name="afgSsq" style="width: 92%" data-options="label:'单位所在区（县）:',readonly:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=05'">
						</li>
						<li class="readonly">
							<input class="easyui-combobox" name="afgDwdz" style="width: 92%" data-options="label:'单位所在街道办事处:',readonly:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=06'">
						</li>
					</ul>
					<div class="applyTab">
					...
					<div id="inner">
						<div>
							...
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-datebox" name="afgBysj" style="width: 92%" data-options="label:'毕业时间:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="afgByyx" style="width: 92%" data-options="label:'毕业学校:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="afgXl" style="width: 92%" data-options="label:'学历:',readonly:true,valueField:'piItemcode',textField:'piItemname',
                                   url:'<%=basePath %>ParmItem/getOptions?parmSetcode=08'">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="afgGrnsr" style="width: 92%" data-options="label:'个人年收入(元):',readonly:true">
								</li>
							</ul>
							<ul class="apply-group windowInner">
								<legend>配偶信息</legend>
							...
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="afgHjdz" style="width: 92%" data-options="label:'户籍地址:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="afgSqhjnx" style="width: 92%" data-options="label:'户籍年限(年):',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="afgJtrks" style="width: 92%" data-options="label:'家庭人口:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="afgJtnsr" style="width: 92%" data-options="label:'家庭年收入(元):',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="afgRjysr" style="width: 92%" data-options="label:'人均月收入(元):',readonly:true">
								</li>
							</ul>
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="applyUnit.bsls" id="applyUnitbsls"  style="width: 92%" data-options="label:'社会统一代码:',readonly:true">
								</li>
								<li class="readonly">
						...
						<div style="display: none;">
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-datebox" name="afgLdhtkssj" style="width: 92%" data-options="label:'劳动合同签订年限:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-datebox" name="afgLdhtjssj" style="width: 92%" data-options="label:'劳动合同终止年限:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-datebox" name="afgSbjnsj" style="width: 83%" data-options="label:'社会保险缴纳情况',readonly:true">至今
								</li>
								<li class="readonly">
									<input class="easyui-datebox" name="afgGjjjnsj" style="width: 83%" data-options="label:'住房公积金缴纳情况',readonly:true">至今
								</li>
							</ul>
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyHouses[0].afhMj" id="applyFamilyHouses0afhMj" style="width: 92%" data-options="label:'坐落面积(m²):',readonly:true">
								</li>
								<li class="readonly">
						...
						<div style="display: none;" id="addPerson">
						</div>
						<div style="display: none;">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                bank.biography().setParams({row:data.afgBaseimg,title:'searchSign'});
            },error:function(){
        ...
        if(data.applyFamilyMembers.length>2){
            for(var i=2;i<data.applyFamilyMembers.length;i++){
                $('#addPerson').append(' <ul class="apply-group windowInner">' +
                    ...
                    '</li>' +
                    '<li class="readonly">' +
                    '<input class="easyui-textbox" name="applyFamilyMembers['+i+'].afmSfzh" id="applyFamilyMembers'+i+'afmSfzh" style="width: 92%" data-options="label:\'身份证号:\',readonly:true">' +
                    '</li>' +
                    '<li class="readonly">' +
