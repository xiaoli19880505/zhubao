	...
	<body>
		...
		<div class="layout mb20">
			...
			<div class="quicklink">
				...
				<a href="<%=basePath %>pageColumn/external/h_transaction" class="bg3">上市交易</a>
			</div>
			<!--快速连接 end-->
		</div>
            ...
            success:function (data) {
                ...
                for (var i = 0;i<data.length;i++) {
                    ...
                    len += '<a href="' + urlImg + '" title=""  style="display:none">'
                        + '<img src="'+ data[i].imgUrl +'" alt="" width="404" height="260"/></a>';
					if(i==5){
						break;
					}
                }
            ...
            success:function(data){
                ...
                if(data.length == 0){
                    ...
                    for (var i = 0;i<data.length;i++){
                        ...
                        list +='<div style="overflow: hidden;background: #fff;margin-bottom: 15px" class="img">'
								+'<div class="close" onclick="closeHouse($(this))">关闭</div>'
								+'<div class="photo" id="footEnd">'
								+'<a class="weix" href="'
								+ extranetUrl + '" >'
