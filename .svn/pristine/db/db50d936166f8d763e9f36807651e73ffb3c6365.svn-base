...
<div data-options="region:'center'" id="center">
    <span class="top-title">公共租赁住房租赁补贴</span>
    <div id="top">
        <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
            ...
            <ul class="input-group">
                ...
                <li>
                    <input class="easyui-combobox" name="abJdbsc" id="abJdbsc"  style="width: 92%" data-options="label:'户籍所在街道办事处:',required:true,valueField:'piItemcode',textField:'piItemname',
            ...
            <div id="inner">
                <div>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li style="text-align: left" class="butieli">
                            ...
                            <input type="checkbox" value="3" id="abTsjt"/><label class="lispan">二级以上下肢重度残疾</label>
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        <legend>配偶信息</legend>
                    ...
                    <ul class="input-group windowInner">
                        <legend>户籍信息</legend>
                        <li>
                            <input class="easyui-textbox" name="abSqhjnx" style="width: 92%" data-options="label:'户籍年限(年):',required:true,required:true,validType:['empty','numberZ','limitHJ[5]']">
                        </li>
                        <li class="readonly">
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox" name="abJtrk" id="abJtrk"  style="width: 92%" data-options="label:'家庭人口:',readonly:true,required:true,validType:['numberZ','empty']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="abRjysr" id="abRjysr" style="width: 92%" data-options="label:'人均月收入(元):',required:true,validType:'number'">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                ...
                <div style="display: none;">
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="abDbzbh" id="abDbzbh" style="width: 92%" data-options="label:'低保/特困证编号:',required:true">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="abLqrs" id="abLqrs" style="width: 92%" data-options="label:'低保/特困领取人数:',required:true,validType:['numberZ','empty']">
                        </li>
                        <li>
                            <input class="easyui-datebox" name="abFzsj" id="abFzsj" style="width: 92%" data-options="label:'低保/特困发证时间:',required:true,editable:false,validType:['minDate','dbAnnual']">
                        </li>
                    </ul>
                    <p class="sbumit right">
                        <span><a href="#">下一步</a></span>
...
<script>
    ...
    function secondSave() {
        ...
        $('#form').form('submit', {
            ...
            onSubmit: function (param) {
                param.abBaseimg = sign.row;
                //二级伤残赋值
                if($("input[type='checkbox']:checked").val() == undefined){
                    param.abTsjt = '';
                } else {
                    param.abTsjt = $("input[type='checkbox']:checked").val();
                }
    ...
    function setValue(form,data){
        ...
        $("#abTsjt[value='"+data.abTsjt+"']").prop("checked", true);
        bank.biography().setParams({row:data.abBaseimg,title:'sign'});
    }
    //图片回显
