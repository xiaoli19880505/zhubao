    ...
    <form id="queryForm">
        ...
        <ul class="search-group">
            <li style="width: 600px">
                ...
                <input type="radio" name="area" value="1" id="1"><label class="lispan" for="1">经适房</label><span class="lispace"></span>
                <input type="radio" name="area" value="2" id="2"><label class="lispan" for="2">公租房(低保特困)</label><span class="lispace"></span>
                <input type="radio" name="area" value="3" id="3"><label class="lispan" for="3">公租房(外来务工、新就业)</label><span class="lispace"></span>
            </li>
...
<script>
    ...
    $("body").on('change','.housecheck input[type="checkbox"]',function(){
