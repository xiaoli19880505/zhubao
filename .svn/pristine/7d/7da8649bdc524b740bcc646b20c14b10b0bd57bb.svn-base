					...
					<div id="inner">
						...
						<%--	<p class="agreenSign">
							...
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyMembers[1].afmLxdh" id="applyFamilyMembers1afmLxdh" style="width: 92%" data-options="label:'联系电话:',readonly:true,validType:'phone'">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyMembers[1].afmNsr" id="applyFamilyMembers1afmNsr" style="width: 92%" data-options="label:'个人年收入(元):',readonly:true,validType:['number','empty']">
								</li>
							</ul>
							<ul class="apply-group windowInner">
								<legend>户籍信息</legend>
        ...
        if(data.applyFamilyMembers.length>2){
            for(var i=2;i<data.applyFamilyMembers.length;i++){
                $('#addPerson').append(' <ul class="apply-group windowInner">' +
                    ...
                    '</li>' +
                    '<li class="readonly">' +
                    '<input class="easyui-textbox" name="applyFamilyMembers['+i+'].afmNsr" id="applyFamilyMembers'+i+'afmNsr" style="width: 92%" data-options="label:\'个人年收入:\',readonly:true">' +
                    '</li>' +
                    '</ul>');
            }
