...
<div data-options="region:'center'" id="center">
    <span class="top-title">公共租赁住房（新就业人员）申请</span>
    <div id="top">
        <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
            <ul class="input-group">
                <li>
                    <input class="easyui-textbox" name="afgDwmc" style="width: 92%" data-options="label:'单位名称:',required:true,prompt:'请输入单位全称',validType:['empty']" >
                </li>
                <li>
                    <input class="easyui-combobox" name="afgSsq" style="width: 92%" data-options="label:'单位所在区（县）:',required:true,valueField:'piItemcode',textField:'piItemname',
                    url:'<%=basePath %>ParmItem/selectSsqExceptCenter',onSelect:selectSSQ,editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                </li>
                <li>
                    <input class="easyui-combobox" name="afgDwdz" id="afgDwdz" style="width: 92%" data-options="label:'街道办事处:',required:true,valueField:'piItemcode',textField:'piItemname',
            ...
            <div id="inner">
                ...
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li class="readonly">
                            <select class="easyui-combobox" name="applyFamilyMembers[0].afmXb" id="applyFamilyMemberas0fmXb" style="width: 92%" data-options="label:'性别:',required:true,readonly:true,editable:false,panelHeight:'auto'" >
                                <option value="男">男</option>
                                <option value="女">女</option>
                            </select>
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmLxdh" id="applyFamilyMembers0afmLxdh" value="${sessionScope.applyUserinfo.linktel}" style="width: 92%" data-options="label:'联系电话:',required:true,readonly:true,validType:'phone'">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmSfzh"  id="applyFamilyMembers0afmSfzh" value="${sessionScope.applyUserinfo.sfzh}" style="width: 92%" data-options="label:'身份证号码:',required:true,readonly:true,validType:['sfz','empty']">
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            url:'<%=basePath %>ParmItem/getOptions?parmSetcode=08',onChange:changeXl,panelHeight:'auto',panelMaxHeight:'250'">
                        </li>
                        <li>
                            <input class="easyui-combobox" name="applyFamilyMembers[0].afmHyzk" id="applyFamilyMembers0afmHyzk" style="width: 92%"
                        ...
                        <li >
                            <input class="easyui-textbox" name="afgGrnsr" id="applyFamilyMembers0afmNsr" style="width: 92%" data-options="label:'个人年收入(元):',required:true,validType:['number','empty'],events:{keyup:changeSr}">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        <legend>配偶信息</legend>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="afgSqhjnx" style="width: 92%" data-options="label:'户籍年限(年):',required:true,validType:['numberZ','empty']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="afgJtrks" id="afgJtrks" value="1" style="width: 92%" data-options="label:'家庭人口:',readonly:true,validType:['numberZ','empty']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="afgJtnsr" id="afgJtnsr" style="width: 92%" data-options="label:'家庭年收入(元):',readonly:true,validType:['number','empty']">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="afgRjysr" id="afgRjysr" style="width: 92%" data-options="label:'人均月收入(元):',readonly:true,validType:['number','empty']">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyUnit.entag" style="width:92%" data-options="label:'委托代理人:',validType:['chinese','specialCharacter']">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyUnit.tel" style="width:92%" data-options="label:'联系方式:',required:true,validType:'phoneTel'">
                        </li>
                        <li>
                ...
                <div style="display: none;">
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-datebox" name="afgLdhtkssj" style="width: 92%" data-options="label:'劳动合同签订年限:',required:true,editable:false,validType:['minDate']">
                        </li>
                        <li>
                            <input class="easyui-datebox" name="afgLdhtjssj" style="width: 92%" data-options="label:'劳动合同终止年限:',required:true,editable:false">
                        </li>
                        <li>
                            <input class="easyui-datebox" name="afgSbjnsj" style="width: 83%" data-options="label:'社会保险缴纳情况:',required:true,editable:false,validType:['minDate','annual']">
                            &nbsp;至今
                        </li>
                        <li>
                            <input class="easyui-datebox" name="afgGjjjnsj" style="width: 83%" data-options="label:'住房公积金缴纳情况:',editable:false,validType:['minDate']">
                            &nbsp;至今
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouses[0].afhMj" id="applyFamilyHouses0afhMj" style="width: 92%" data-options="label:'房屋面积(m²):',required:true,validType:'number',events:{keyup:changeMj}" >
                        </li>
                        <li class="readonly">
                        ...
                        <li>
                            <input class="easyui-combobox" name="applyFamilyHouses[0].afhZfxz" style="width: 92%" data-options="label:'现住房性质:',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=01',
                            editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                        </li>
                    </ul>
                    <p class="sbumit right">
...
<script>
    var person=false;var i = 1;//设置家庭人口
    var j=0,sucIndex=0, num = "",currentIndex=0,codeArray=[],nameArray = [],idArray=[],sendArray=[];
        ...
        if(newArray.length>0){
            ...
            uploader.on( 'uploadSuccess', function( file ) {
                ...
                if(sucIndex==newArray.length){
                    ...
                    setTimeout(function () {
                        $(".over").hide();
                        var tabIndex=parent.$("#AllTabs").tabs("getTabIndex", parent.$("#AllTabs").tabs("getTab","发起申请"));
                        parent.$("#AllTabs").tabs("close", tabIndex);
                        return false;
                    },2500);
                }
            });
    ...
    function secondSave() {
        ...
        var flag=false;
        $('#form').form('submit', {
            url: '<%=basePath %>applyForgraDuate/addApplyForgraDuate',
            onSubmit: function (param) {
                param.afgBaseimg = signApply.row;
        ...
        if(person){
           ...
           var perString= $('<ul class="input-group windowInner">' +
               ...
               '</li>' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex + '].afmNsr" id="applyFamilyMembers' + addIndex + 'afmNsr" value="0" style="width: 92%" data-options="label:\'个人年收入(元):\',required:true,validType:[\'number\',\'empty\'],events:{keyup:changeSr}">' +
                '</li>' +
    ...
    $(function () {
        $('#applyFamilyMemberas0fmXb').combobox('setValue','${sessionScope.applyUserinfo.sex}');
    })
</script>