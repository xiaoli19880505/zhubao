	...
	<div class="easyui-panel resPanel" style="width: 100%;height: 98%;overflow: auto">
		<table id="dataTable" class="easyui-datagrid resTable" style="height: 100%;min-height: 300px"
			...
			<tr>
				...
				<th data-options="field:'applicationDate',width:150,align:'center',halign:'center'">性别</th>
				...
				<th data-options="field:'totalPrice',width:100,align:'left',halign:'center'">家庭地址</th>
				...
				<th data-options="field:'addtionWay',width:100,align:'left',halign:'center'">创建时间</th>
				<th data-options="field:'invoiceNo',width:100,align:'center',halign:'center'">审核日期</th>
				<th data-options="field:'purpose',width:100,align:'left',halign:'center'">审核人</th>
...
<script>
    function operate(value,row,index) {
        var id=row.id;
        return '<a onclick="cut('+id+','+index+')">删除</a>'
    }
