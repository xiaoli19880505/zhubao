...
<div data-options="region:'center'" id="center">
    <span class="top-title">公共租赁住房（低保、特困家庭）年审申请</span>
    <div id="top">
            ...
            <div id="inner">
                <div>
                    <ul class="input-group windowInner">
                        <legend>申请人信息</legend>
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmXm" id="applyFamilyMembers0afmXm" value="${sessionScope.applyUserinfo.username}" style="width: 92%" data-options="label:'姓名:',required:true,readonly:true">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmSfzh" id="applyFamilyMembers0afmSfzh" value="${sessionScope.applyUserinfo.sfzh}" style="width: 92%" data-options="label:'身份证号码:',required:true,validType:'sfz',readonly:true">
                        </li>
                        <li class="readonly">
                        ...
                        <li>
                            <select class="easyui-combobox" name="applyFamilyMembers[0].afmHyzk"  id="applyFamilyMembers0afmHyzk" style="width: 92%" data-options="label:'婚姻状况:',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=07',
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmLxdh" value="${sessionScope.applyUserinfo.linktel}" style="width: 92%" data-options="label:'联系电话:',required:true,validType:'numberZ',readonly:true">
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <input type="checkbox" value="2" />二级以上下肢重度残疾
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        <legend>配偶信息</legend>
                    ...
                    <ul class="input-group windowInner">
                        <legend>户籍信息</legend>
                        <li>
                            <input class="easyui-textbox" name="apSqhjnx" style="width: 92%" data-options="label:'户籍年限:',required:true,validType:['numberZ','limitHJ[5]','empty']">
                        </li>
                        <li class="readonly">
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox" name="apJtrk" id="apJtrk" style="width: 92%" value="1" data-options="label:'家庭人口:',required:true,readonly:true,validType:['numberZ','empty']">
                        </li>
                        <li class="readonly">
                ...
                <div style="display: none;">
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-combobox" name="applyFamilyHouses[0].afhZfxz" id="applyFamilyHouses0afhZfxz" style="width: 92%" data-options="label:'现住房性质:',required:true,valueField:'piItemcode',
                            textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=01',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
...
<script>
    ...
    var j =0,num = "",sucIndex=0,currentIndex=0,codeArray=[],nameArray = [],idArray=[],sendArray=[];
