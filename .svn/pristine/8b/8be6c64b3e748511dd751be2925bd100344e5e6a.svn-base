				...
				<div class="mui-scroll">
					<form method="post" id="form" class="easyui-form" enctype="multipart/form-data" >
						...
						<div id="wrap1">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow readonlyRow">
											<input class="easyui-combobox" name="abSsq"  data-options="label:'户籍所在区(县)',readonly:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=05'">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-combobox" name="abJdbsc"  data-options="label:'户籍所在街道办事处',readonly:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=06'">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="abSqjwh"  data-options="label:'户籍所在社区',required:true,readonly:true">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										...
										<div class="commonRow readonlyRow">
											...
											<input type="checkbox" name="abTsjt" value="3" disabled/><label class="lispan">二级以上下肢重度残疾</label>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="abSqhjnx"  data-options="label:'户籍年限',readonly:true">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="abJtnsr"  data-options="label:'家庭年收入',readonly:true">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="abJtrk"  data-options="label:'家庭人口',readonly:true">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="abRjysr"  data-options="label:'人均月收入',readonly:true">
										</div>
									</div>
								</div>
							</div>
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										...
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="applyUnit.bsls" id="applyUnitbsls"   data-options="label:'营业执照号',readonly:true">
										</div>
										<div class="commonRow readonlyRow">
						...
						<div id="wrap2" style="display: none;">
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="applyFamilyHouses[0].afhZl"  id="applyFamilyHouses0afhZl"  data-options="label:'房屋地址',readonly:true">
										</div>
										<div class="commonRow readonlyRow">
										...
										<div class="commonRow readonlyRow">
											<input class="easyui-combobox" name="applyFamilyHouses[0].afhZfxz" id="applyFamilyHouses0afhZfxz"  data-options="label:'现住房性质',readonly:true,valueField:'piItemcode',textField:'piItemname',
							...
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="applyFamilyHouseChange.afhcYzfzl" id="applyFamilyHouseChangeafhcYzfzl"  data-options="label:'原住房地址',readonly:true">
										</div>
										<div class="commonRow readonlyRow">
										...
										<div class="commonRow readonlyRow">
											...
											<input type="radio" name="applyFamilyHouseChange.afhcBgfs" value="拆迁"  required/>拆迁&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="radio" name="applyFamilyHouseChange.afhcBgfs" value="转让" />转让
										</div>
										...
										<div class="commonRow readonlyRow" id="cq">
											<input class="easyui-textbox" name="applyFamilyHouseChange.afhcZrbcje" id="applyFamilyHouseChangeafhcZrbcje"  data-options="label:'货币补偿金额',readonly:true">
										</div>
									</div>
								</div>
							</div>
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfzl" id="applyFamilyHouseChangeafhcAzfzl"  data-options="label:'安置房地址',readonly:true">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfjzmj" id="applyFamilyHouseChangeafhcAzfjzmj"  data-options="label:'建筑面积',readonly:true">
										</div>
									</div>
								</div>
							</div>
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox"  name="abDbzbh" id="abDbzbh"  data-options="label:'低保/特困证编号',readonly:true">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="abLqrs" id="abLqrs" data-options="label:'低保/特困领取人数',readonly:true">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="abFzsj" id="abFzsj" data-options="label:'低保/特困发证时间',readonly:true">
										</div>
									</div>
								</div>
							</div>
						...
						<div id="wrap4" style="display: none;">
							...
							<div class="mui-card">
								<!--页眉，放置标题-->
								<div class="mui-card-header"><span class="name">特殊情况证明<span class="reqSpan">*(必填)</span></span><span id="type3" class="detail">详情</span></div>
								<!--内容区-->
								<div class="mui-card-content">
        ...
        if(data.applyFamilyMembers.length>2){
            for(var i=2;i<data.applyFamilyMembers.length;i++){
                $(".card-container").append('<div class="mui-card">' +
                    ...
                    '            </div>' +
                    '            <div class="commonRow readonlyRow">' +
                    '<input class="easyui-textbox" name="applyFamilyMembers['+i+'].afmNsr" id="applyFamilyMembers'+i+'afmNsr"  data-options="label:\'年收入\',readonly:true">' +
                    '            </div>' +
                    '       </div>' +
                    '     </div>' +
                    '</div>')
