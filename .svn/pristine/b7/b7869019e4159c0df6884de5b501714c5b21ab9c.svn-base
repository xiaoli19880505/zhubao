	...
	<%--	<aside class="mui-off-canvas-left" id="offCanvasSide">
		...
		<%--<div class="mui-inner-wrap">--%>
			...
			<header class="mui-bar mui-bar-nav">
				...
				<h1 class="mui-title">低保特困住保补贴申请</h1>
			</header>
						...
						<div id="wrap0">
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									...
									<div class="mui-row" style="padding:5px">1、公共租赁住房租赁补贴保障有效期为一年，按年度进行审核，补贴协议一年一签。保障家庭应在保障有效期届满前30天内，向市住房保障服务中心提交相关材料进行资格年审。经年审符合条件的，可继续按规定申领补贴；年审不符合条件的，补贴保障终止；未按规定进行资格审核的，视为自愿放弃租赁补贴资格，将停发租赁补贴。</div>
						...
						<div id="wrap2" style="display: none;">
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow">
											<input class="easyui-combobox" name="abSsq"  data-options="label:'户籍所在区(县)',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/selectSsqExceptCenter',onSelect:selectSSQ,editable:false,panelHeight:'auto',panelMaxHeight:'280'">
										</div>
										<div class="commonRow">
											<input class="easyui-combobox" name="abJdbsc" id="abJdbsc"  data-options="label:'街道办事处',required:true,valueField:'piItemcode',textField:'piItemname',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
										</div>
										<div class="commonRow">
											<input class="easyui-textbox" name="abSqjwh"  data-options="label:'户籍所在社区',required:true,validType:['chinese','empty']">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										...
										<div  class="commonRow">
											...
											<input type="checkbox" name="abTsjt" value="3" /><label class="lispan">二级以上下肢重度残疾</label>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow">
											<input class="easyui-textbox" name="abSqhjnx"  data-options="label:'户籍年限(年)',required:true,validType:['empty','numberZ','limitHJ[5]']">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="abJtnsr" id="abJtnsr"  data-options="label:'家庭年收入(元)',readonly:true,required:true,validType:['number','empty']">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="abJtrk"  id="abJtrk" value="1"  data-options="label:'家庭人口',readonly:true,required:true,validType:['numberZ','empty']">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="abRjysr" id="abRjysr"  data-options="label:'人均月收入(元)',readonly:true,required:true,validType:['number','empty']">
										</div>
									</div>
								</div>
							</div>
						...
						<div id="wrap3" style="display: none;">
							...
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow">
											<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfzl"   data-options="label:'安置房地址',validType:['empty']">
										</div>
										<div class="commonRow">
											<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfjzmj"  data-options="label:'建筑面积(m²)',validType:['number','empty']">
										</div>
									</div>
								</div>
							</div>
							...
							<!--内容区-->
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow">
											<input class="easyui-textbox" name="abDbzbh" data-options="label:'低保/特困证编号',required:true">
							             </div>
							            <div class="commonRow">
											<input class="easyui-textbox" name="abLqrs" data-options="label:'低保/特困领取人数',required:true,validType:['numberZ','empty']">
							            </div>
										<div class="commonRow">
	                                        <input class="easyui-datebox" name="abFzsj" data-options="label:'低保/特困发证时间',required:true,editable:false,validType:['dbAnnual']">
	                                    </div>
							        </div>
							    </div>
							</div>
...
<script>
    ...
    function secondSave() {
        ...
        var abTsjt=$.trim($("input[name='abTsjt']:checked").val());
        $('#form').form('submit', {
            url: '<%=basePath %>applyButie/addApplyInfo',
            onSubmit: function (param) {
	            param.abBaseimg=paramSign;
	           param.abTsjt=abTsjt;//二级残疾
