...
<body class="easyui-layout" id="xjy">
					...
					<div id="inner">
						...
						<%--	<p class="agreenSign">
							...
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<select class="easyui-combobox" name="applyFamilyMembers[1].afmYsqrgx" id="applyFamilyMembers1afmYsqrgx" style="width: 92%" data-options="label:'关系:',valueField:'piItemname',textField:'piItemname',panelHeight:'auto',readonly:true,editable:false">
						...
						<div style="display: none;">
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-datebox" name="affSbjnsj" style="width: 83%" data-options="label:'社会保险缴纳情况',readonly:true">
									&nbsp;至今
								</li>
								<li class="readonly">
									<input class="easyui-datebox" name="affGjjjnsj" style="width: 83%" data-options="label:'住房公积金缴纳情况',readonly:true">
									&nbsp;至今
								</li>
							</ul>
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyHouses[0].afhMj" id="applyFamilyHouses0afhMj" style="width: 92%" data-options="label:'房屋面积(m²):',readonly:true">
								</li>
								<li class="readonly">
