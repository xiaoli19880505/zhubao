						...
						<div id="wrap1" >
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div style="display: none">
											<input class="easyui-textbox" name="afgId" id="afgId">
										</div>
										<div class="commonRow">
											<input class="easyui-textbox" name="afgDwmc"  data-options="label:'单位名称',required:true,prompt:'请输入单位全称'">
										</div>
										<div class="commonRow">
											<input class="easyui-combobox" name="afgSsq"  data-options="label:'单位所在区(县)',required:true,valueField:'piItemcode',textField:'piItemname',
                                          url:'<%=basePath %>ParmItem/selectSsqExceptCenter',onSelect:selectSSQ,editable:false,panelHeight:'auto',panelMaxHeight:'280'">
										</div>
										<div class="commonRow">
											<input class="easyui-combobox" name="afgDwdz" id="afgDwdz"  data-options="label:'单位所在街道办事处',required:true,valueField:'piItemcode',textField:'piItemname',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
							...
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div style="display: none">
											<input class="easyui-textbox" name="afgSqrid" id="afgSqrid"  data-options="label:'afgSqrid'">
										</div>
										<div style="display: none">
										...
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="applyFamilyMembers[0].afmXm" id="applyFamilyMembers0afmXm"  data-options="label:'姓名',required:true,readonly:true,validType:['empty','chinese','specialCharacter']">
										</div>
										<div class="commonRow readonlyRow">
										...
										<div class="commonRow">
											<input class="easyui-textbox" name="afgByyx"  data-options="label:'毕业学校',required:true,validType:['empty']">
										</div>
										<div class="commonRow">
							...
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										...
										<div class="commonRow">
											<input class="easyui-textbox" name="afgSqhjnx"  data-options="label:'户籍年限(年)',required:true,validType:['numberZ','empty']">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="afgJtrks" id="afgJtrks"  data-options="label:'家庭人口',readonly:true,validType:['numberZ','empty']">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="afgJtnsr" id="afgJtnsr"  data-options="label:'家庭年收入(元)',readonly:true,validType:['number','empty']">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="afgRjysr" id="afgRjysr"  data-options="label:'人均月收入(元)',readonly:true,validType:['number','empty']">
										</div>
									</div>
								</div>
							</div>
						...
						<div id="wrap2" style="display: none;">
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										<div class="commonRow">
											<input class="easyui-datebox" name="afgLdhtkssj" data-options="label:'劳动合同签订年限',required:true,editable:false,validType:['minDate']">
										</div>
										<div class="commonRow">
											<input class="easyui-datebox" name="afgLdhtjssj" data-options="label:'劳动合同终止年限',required:true,editable:false">
										</div>
										<div class="commonRow">
											<input class="easyui-datebox" name="afgSbjnsj"  data-options="label:'社会保险缴纳情况',required:true,editable:false,validType:['minDate','annual']">至今
										</div>
										<div class="commonRow">
											<input class="easyui-datebox" name="afgGjjjnsj" data-options="label:'住房公积金缴纳情况',editable:false,validType:['minDate']">至今
										</div>
									</div>
								</div>
							</div>
							<div class="mui-card">
								...
								<div class="mui-card-content" >
									<div class="mui-input-group">
										...
										<div class="commonRow">
											<input class="easyui-textbox" name="applyFamilyHouses[0].afhMj" id="applyFamilyHouses0afhMj"   data-options="label:'房屋面积(m²)',required:true,validType:'number',events:{keyup:changeMj}">
										</div>
										<div class="commonRow readonlyRow">
											<input class="easyui-textbox" name="applyFamilyHouses[0].afhRjmj" id="applyFamilyHouses0afhRjmj"  data-options="label:'人均建筑面积(m²)',required:true,validType:'number'">
										</div>
										<div class="commonRow">
...
<script>
    ...
    function secondSave() {
        ...
        var flag=false;
        $('#form').form('submit', {
            url: '<%=basePath %>applyForgraDuate/updateApplyForgraDuate',
            onSubmit: function (param) {
                param.afgBaseimg=paramSign;
    ...
    mui(".mui-card").on('tap', '.greenPan', function(e) {
        ...
        if(person){
            ...
            var perString=$('<div class="mui-card">' +
				...
				'            </div>' +
                '            <div class="commonRow">' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' +addIndex + '].afmGzdw" data-options="label:\'工作单位\',required:true,prompt:\'请输入单位全称\',validType:[\'empty\']">' +
                '            </div>' +
                '            <div class="commonRow">' +
    ...
    function changeSr(obj){
        ...
        //计算年收入，平均收入
        $("#afgJtnsr").textbox('setValue',sum);
        $("#afgRjysr").textbox('setValue',average);
    }
    //先输入了姓名后选择关系
