...
public interface ApproveMapper extends IMapper<Approve> {
    ...
    /*条件查询*/
    List<Map> findNoSignToMes(Map map);
     ...
     * @return
     */
    Approve h5FindPerApply(Map map);
    /**
     * 我的年审单条部分信息
     * @param map 申请id和申请编号
     * @return
     */
    Approve h5FindPerAudio(Map map);
     ...
     * @return
     */
    Integer selectForDeWeighting(Map map);
