					...
					<div id="inner">
						...
						<%--	<p class="agreenSign">
							...
							<ul class="apply-group windowInner">
								...
								<li style="width: 600px;text-align: left" class="butieli">
									<label class="lilabel">是否特殊家庭:</label>
									<input type="checkbox" name="apTsjt" value="3" disabled style="margin-left: 20px"/><label class="lispan">二级以上下肢重度残疾</label>
								</li>
							</ul>
							<ul class="apply-group windowInner">
								<legend>配偶信息</legend>
						...
						<div style="display: none;">
							...
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="apDbzbh" id="apDbzbh" style="width: 92%" data-options="label:'低保/特困证编号:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="apLqrs" id="apLqrs" style="width: 92%" data-options="label:'低保/特困领取人数:',readonly:true,validType:['numberZ','empty']">
								</li>
								<li class="readonly">
									<input class="easyui-datebox" name="apFzsj" id="apFzsj" style="width: 92%" data-options="label:'低保/特困发证时间',readonly:true,editable:false,validType:['minDate']">
								</li>
							</ul>
						</div>
	...
	<div class="auditRestlt">
		...
		<ul class="search-group">
			...
			<li class="time" style="display:none;width: 380px">
				<input class="easyui-datebox" id="sqrq" style="width: 92%" data-options="label:'通知签订协议时间',validType:['overDate'],editable:false,required:true">
			</li>
			<li class="doc" style="display:none;width: 380px">
				<input class="easyui-textbox" id="doc" style="width: 92%" data-options="label:'携带资料名称',validType:['empty'],required:true">
			</li>
    ...
    function submit(){
        ...
        if(flag){
            ...
            if(approveResult.length>0&&comment.length>0){
                if(approveResult=="1"&&"${reaudit}"=="1"){
                    var sendTime=$.trim($("#sqrq").datebox('getValue'));//发送日期
                    var doc=$.trim($("#doc").textbox('getValue'));//发送日期
                    if(sendTime.length==0||doc.length==0){
                        flag=true;
                        bank.alertMessage("签订时间和资料名称不能为空")
					}else{
                        mesData.sqrq=sendTime;
                        mesData.doc=doc;
