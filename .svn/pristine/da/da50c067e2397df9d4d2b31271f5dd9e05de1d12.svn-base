...
<div class="easyui-navpanel">
    ...
    <div class="mui-off-canvas-wrap mui-draggable mui-slide-in">
        ...
        <header class="mui-bar mui-bar-nav">
            ...
            <h1 class="mui-title">公共租赁住房(新就业人员)年审申请</h1>
        </header>
            ...
            <div class="mui-scroll">
                <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
                    ...
                    <div id="wrap1">
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="affDwmc" data-options="label:'单位名称',required:true">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-combobox" name="apSsq" data-options="label:'单位所在区(县)',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/selectSsqExceptCenter',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-combobox" name="apJdbsc" data-options="label:'单位所在街道',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=06',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    <div style="display: none">
                                        <input class="easyui-textbox" name="apSqrid" data-options="label:'afgSqrid'">
                                    </div>
                                    <div style="display: none">
                                    ...
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="applyFamilyMembers[0].afmXm" id="applyFamilyMembers0afmXm"
                                               data-options="label:'姓名',required:true,readonly:true,validType:['empty','chinese','specialCharacter']">
                                    </div>
                                    <div class="readonlyRow commonRow">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyFamilyMembers[0].afmSfzh" id="applyFamilyMembers0afmSfzh" data-options="label:'身份证号码',required:true,validType:'sfz',readonly:true">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-datebox" name="afgBysj" data-options="label:'毕业时间',required:true,editable:false,validType:['fiveAfter']">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="afgByyx" data-options="label:'毕业学校',required:true">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-combobox" name="afgXl" id="afgXl" data-options="label:'学历',required:true,editable:false,valueField:'piItemname',textField:'piItemname',
                                    ...
                                    <div class="commonRow">
                                        <select class="easyui-combobox" name="applyFamilyMembers[0].afmHyzk"
                                                id="applyFamilyMembers0afmHyzk" data-options="label:'婚姻状况',required:true,valueField:'piItemcode',textField:'piItemname',
	                                        	url:'<%=basePath %>ParmItem/getOptions?parmSetcode=07',editable:false,panelHeight:'auto',panelMaxHeight:'280',onSelect:selecthyzk">
                                        </select>
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="afgGrnsr" id="applyFamilyMembers0afmNsr" data-options="label:'个人年收入(元)',required:true,validType:'number',events:{keyup:changeSr}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="afgHjdz" data-options="label:'户籍地址',required:true,validType:['checkHj','empty']">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="apSqhjnx" data-options="label:'户籍年限(年)',required:true,validType:['numberZ','empty']">
                                    </div>
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="apJtrk" id="apJtrk" data-options="label:'家庭人口',readonly:true,validType:['numberZ','empty']">
                                    </div>
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="apJtnsr" id="apJtnsr" data-options="label:'家庭年收入(元)',readonly:true,validType:['number','empty']">
                                    </div>
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="apRjysr" id="apRjysr" data-options="label:'人均月收入(元)',readonly:true,validType:['number','empty']">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyUnit.bsls" id="applyUnitbsls" data-options="label:'统一社会信用代码',required:true,validType:['empty','xyCode']">
                                    </div>
                                    <div class="commonRow">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyUnit.tel" id="applyUnittel" data-options="label:'手机号码',required:true,validType:['phoneTel','empty']">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyUnit.address" id="applyUnitaddress" data-options="label:'联系住址',required:true,validType:['empty']">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="wrap2" style="display: none;">
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    <div class="commonRow">
                                        <input class="easyui-datebox" name="affLdhtkssj" data-options="label:'劳动合同签订年限',required:true,editable:false,validType:['minDate','annual']">
                                    </div>
                                    <div class="commonRow">
                        ...
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyFamilyHouses[0].afhCqr" id="applyFamilyHouses0afhCqr"
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyFamilyHouses[0].afhMj" id="applyFamilyHouses0afhMj"
                                               data-options="label:'房屋面积',required:true,validType:'number',events:{keyup:changeMj}">
                                    </div>
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="applyFamilyHouses[0].afhRjmj" id="applyFamilyHouses0afhRjmj"
                                               data-options="label:'人均建筑面积',required:true,validType:'number',readonly:true">
                                    </div>
                                    <div class="commonRow">
                    ...
                    <div id="wrap4" style="display: none;">
                        ...
                        <div class="mui-card">
                            <!--页眉，放置标题-->
                            <div class="mui-card-header"><span><span class="name">户口簿(含首页)</span><span class="reqSpan">*(必填)</span></span></div>
                            <!--内容区-->
                            <div class="mui-card-content">
                        ...
                        <div class="mui-card">
                            <!--页眉，放置标题-->
                            <div class="mui-card-header"><span><span class="name">劳动合同或者聘用合同(加盖公章)</span><span class="reqSpan">*(必填)</span></span></div>
                            <!--内容区-->
                            <div class="mui-card-content">
                        ...
                        <div class="mui-card">
                            <!--页眉，放置标题-->
                            <div class="mui-card-header"><span><span class="name">大中专院校毕业证书</span><span class="reqSpan">*(必填)</span></span><span id="type8" class="detail">详情</span></div>
                            <!--内容区-->
                            <div class="mui-card-content">
    ...
    mui(".mui-card").on('tap', '.greenPan', function (e) {
        ...
        if (person) {
            ...
            var perString = $('<div class="mui-card">' +
                ...
                '       <div class="mui-input-group">' +
                '            <div class="commonRow">' +
                '<input class="easyui-combobox" name="applyFamilyMembers[' + addIndex+ '].afmYsqrgx" id="applyFamilyMembers' + addIndex + 'afmYsqrgx"  data-options="label:\'关系\',valueField:\'piItemname\',textField:\'piItemname\',url:\'<%=basePath %>ParmItem/findFamylyOnlypozn\',required:true,editable:false,panelHeight:\'auto\',panelMaxHeight:\'280\',onSelect:selectMemberHy">' +
                '            </div>' +
                '            <div class="commonRow">' +
                ...
                '            </div>' +
                '            <div class="commonRow readonlyRow">' +
                '<input class="easyui-combobox" name="applyFamilyMembers[' + addIndex + '].afmHyzk" id="applyFamilyMembers' + addIndex+ 'afmHyzk"  data-options="label:\'婚姻状况\',valueField:\'piItemcode\',textField:\'piItemname\',url:\'<%=basePath %>ParmItem/getOptions?parmSetcode=07\',required:true,editable:false,panelHeight:\'auto\',panelMaxHeight:\'280\',readonly:true">' +
                '            </div>' +
                '            <div class="commonRow">' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex + '].afmGzdw" data-options="label:\'工作单位\',prompt:\'请输入单位全称\',validType:[\'empty\']">' +
                '            </div>' +
                '            <div class="commonRow">' +
                ...
                '            </div>' +
                '            <div class="commonRow">' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex+ '].afmNsr" id="applyFamilyMembers' + addIndex+ 'afmNsr"  data-options="label:\'个人年收入(元)\',required:true,validType:[\'number\',\'empty\'],events:{keyup:changeSr}">' +
                '            </div>' +
                '       </div>' +
                '     </div>' +
        ...
        if (data.applyFamilyMembers.length > 2) {
            for (var i = 2; i < data.applyFamilyMembers.length; i++) {
                $('<div class="mui-card">' +
                    ...
                    '            </div>' +
                    '            <div class="commonRow">' +
                    '<input class="easyui-combobox" name="applyFamilyMembers[' + i + '].afmYsqrgx" id="applyFamilyMembers' + i + 'afmYsqrgx"  data-options="label:\'关系\',valueField:\'piItemname\',textField:\'piItemname\',url:\'<%=basePath %>ParmItem/findFamylyOnlypozn\',required:true,readonly:true,editable:false,panelHeight:\'auto\',panelMaxHeight:\'280\'">' +
                    '            </div>' +
                    '            <div class="commonRow">' +
                    ...
                    '            </div>' +
                    '            <div class="commonRow readonlyRow">' +
                    '<input class="easyui-datebox" name="applyFamilyMembers[' + i + '].afmCsny" id="applyFamilyMembers' + i + 'afmCsny"  data-options="label:\'出生年月\',readonly:true,editable:false">' +
                    '            </div>' +
                    '            <div class="commonRow readonlyRow">' +
                    '<input class="easyui-combobox" name="applyFamilyMembers[' + i + '].afmHyzk" id="applyFamilyMembers' + i + 'afmHyzk"  data-options="label:\'婚姻状况\',valueField:\'piItemcode\',textField:\'piItemname\',url:\'<%=basePath %>ParmItem/getOptions?parmSetcode=07\',required:true,editable:false,panelHeight:\'auto\',panelMaxHeight:\'280\',readonly:true">' +
                    '            </div>' +
                    '            <div class="commonRow">' +
                    ...
                    '            </div>' +
                    '            <div class="commonRow">' +
                    '<input class="easyui-textbox" name="applyFamilyMembers[' + i + '].afmNsr" id="applyFamilyMembers' + i + 'afmNsr"  data-options="label:\'个人年收入(元)\',required:true,validType:\'number\'">' +
                    '            </div>' +
                    '       </div>' +
                    '     </div>' +
                    '</div>').appendTo(".card-container");
