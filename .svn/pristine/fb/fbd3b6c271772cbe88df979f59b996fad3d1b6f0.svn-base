            ...
            <div class="mui-scroll">
                <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
                    ...
                    <div id="wrap1">
                                ...
                                <div class="mui-input-group">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-combobox" name="apSsq" data-options="label:'户籍所在区(县)',required:true,valueField:'piItemcode',textField:'piItemname',
											url:'<%=basePath %>ParmItem/selectSsqExceptCenter',onSelect:selectSSQ,panelHeight:'auto',panelMaxHeight:'280',editable:false">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-combobox" name="apJdbsc" id="apJdbsc" data-options="label:'户籍所在街道办事处',required:true,valueField:'piItemcode',textField:'piItemname',panelHeight:'auto',panelMaxHeight:'280',editable:false">
                                    </div>
                                    <div class="commonRow">
                                ...
                                <div class="mui-input-group">
                                    ...
                                    <div class="commonRow readonlyRow">
                                        <input class="easyui-textbox" value="${sessionScope.applyUserinfo.sfzh}" name="applyFamilyMembers[0].afmSfzh" id="applyFamilyMembers0afmSfzh"
                                               data-options="label:'身份证号',required:true,validType:['sfz','empty'],readonly:true">
                                    </div>
                                    <div class="commonRow readonlyRow">
                        ...
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    <div style="display: none">
                                        <input class="easyui-textbox" name="applyUnit.aplid" id="applyUnitaplid" data-options="label:'afhId:',prompt:'非必填'">
                                    </div>
                                    <div style="display: none">
                                        <input class="easyui-textbox" name="applyUnit.unitid" id="applyUnitunitid" data-options="label:'afhSqid:',prompt:'非必填'">
                                    </div>
                                    <div class="commonRow">
                        ...
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyFamilyHouseChange.afhcCqr" id="applyFamilyHouseChangeafhcCqr" data-options="label:'原产权人',validType:['chinese','specialCharacter']">
                                    </div>
                                    <div class="commonRow">
                    ...
                    <div id="wrap5" style="display: none;">
                        ...
                        <div class="mui-card">
                            <!--页眉，放置标题-->
                            <div class="mui-card-header"><span><span class="name">特殊情况证明</span><span class="reqSpan">*(必填)</span><span id="type3" class="detail">详情</span></span></div>
                            <!--内容区-->
                            <div class="mui-card-content">
                        ...
                        <div class="mui-card">
                            <!--页眉，放置标题-->
                            <div class="mui-card-header"><span><span class="name">户籍所在地社区公示证明</span><span class="reqSpan">*(必填)</span></span>
                            </div>
                            <!--内容区-->
                            <div class="mui-card-content">
...
<script>
    mui.init();
    var person = false;var i=1;//人口控制变量
