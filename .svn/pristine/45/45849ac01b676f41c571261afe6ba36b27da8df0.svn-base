                        ...
                        <div id="wrap2" style="display: none;">
                            ...
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        <div class="commonRow">
                                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmXm" id="applyFamilyMembers1afmXm"  data-options="label:'姓名',validType:['empty','chinese','specialCharacter'],events:{blur:checkUser}">
                                        </div>
                                        <div class="commonRow">
                                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmSfzh" id="applyFamilyMembers1afmSfzh"  data-options="label:'身份证号码',validType:['sfz','empty'],events:{blur:checkUser}">
                                        </div>
                                        <div class="commonRow">
                                        ...
                                        <div class="commonRow">
                                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmLxdh" id="applyFamilyMembers1afmLxdh" data-options="label:'联系电话',validType:['phone','empty']">
                                        </div>
                                        <div class="commonRow readonlyRow">
                                        ...
                                        <div class="commonRow">
                                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmNsr" id="applyFamilyMembers1afmNsr"  data-options="label:'个人年收入(元)',validType:['empty','number'],events:{keyup:changeSr}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mui-content-padded" style="margin-top: 2rem;">
                                <button class="mui-btn mui-btn-block mui-btn-primary"  id='next3'>下一步</button>
                            </div>
                        </div>
