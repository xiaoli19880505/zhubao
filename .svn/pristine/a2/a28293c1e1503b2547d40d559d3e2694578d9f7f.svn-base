...
public class SourceHouseService extends BaseService<SourceHouse>{
    ...
    public Map<String,Object> updateReturnHpuseFile(String applyid,HttpServletRequest request, HttpServletResponse response) throws Exception {
        Map<String,Object> map=new HashMap<String, Object>();
        map.put("applyid",applyid);
        ...
        if(approveList==null||approveList.size()==0){
            //return "审批单不存在,或已退房";
            resultMap.put("result","审批单不存在,或已退房");
            resultMap.put("flag",false);
            return resultMap;
        }
...
//        FileUtils.buildResponseEntity(response, new File(pdfPath), "application/pdf");
     ...
     * @throws Exception
     */
    public Map<String,Object> updateJSFHouseFile(String applyid,HttpServletRequest request) throws Exception {
        Map<String,Object> map=new HashMap<String, Object>();
        map.put("applyid",applyid);
