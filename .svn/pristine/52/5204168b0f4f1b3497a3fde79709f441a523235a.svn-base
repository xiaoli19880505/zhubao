...
<div class="easyui-navpanel">
    ...
    <div class="mui-off-canvas-wrap mui-draggable mui-slide-in">
        ...
        <header class="mui-bar mui-bar-nav">
            ...
            <h1 class="mui-title">公共租赁住房(低保、特困家庭)年审申请</h1>
        </header>
                    ...
                    <div id="wrap1">
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    ...
                                    <div class=" commonRow">
                                        <input class="easyui-combobox" name="apJdbsc" id="apJdbsc"
                                               data-options="label:'户籍所在街道办事处',required:true,valueField:'piItemcode',textField:'piItemname',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                                    </div>
                                    <div class=" commonRow">
                        ...
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    <div style="display: none">
                                        <input class="easyui-textbox" name="apSqrid" id="apSqrid" data-options="label:'abSqrid'">
                                    </div>
                                    <div style="display: none">
                                    ...
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" value="${sessionScope.applyUserinfo.username}" name="applyFamilyMembers[0].afmXm" id="applyFamilyMembers0afmXm"
                                               data-options="label:'姓名',required:true,readonly:true,validType:['empty','chinese','specialCharacter']">
                                    </div>
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" value="${sessionScope.applyUserinfo.sfzh}" name="applyFamilyMembers[0].afmSfzh" id="applyFamilyMembers0afmSfzh"
                                               data-options="label:'身份证号码',required:true,validType:['sfz','empty'],readonly:true">
                                    </div>
                                    <div class="readonlyRow commonRow">
                                        <select class="easyui-combobox" name="applyFamilyMembers[0].afmXb" value="${sessionScope.applyUserinfo.sex}" id="applyFamilyMembers0afmXb"
                                                data-options="label:'性别',required:true,readonly:true,editable:false,panelHeight:'auto'">
                                            <option value="男">男</option>
                                            <option value="女">女</option>
                                        </select>
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-combobox" name="applyFamilyMembers[0].afmHyzk" id="applyFamilyMembers0afmHyzk" data-options="label:'婚姻状况',required:true,valueField:'piItemcode',textField:'piItemname',
                                    ...
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="applyFamilyMembers[0].afmLxdh" id="applyFamilyMembers0afmLxdh" value="${sessionScope.applyUserinfo.linktel}" data-options="label:'联系电话',required:true,validType:'phone',readonly:true">
                                    </div>
                                    <div class="commonRow">
                        ...
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    ...
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyFamilyMembers[1].afmXm" id="applyFamilyMembers1afmXm"
                                               data-options="label:'姓名',validType:['chinese','specialCharacter']">
                                    </div>
                                    <div class="commonRow">
                                        <input class="easyui-textbox" name="applyFamilyMembers[1].afmSfzh" id="applyFamilyMembers1afmSfzh"
                                               data-options="label:'身份证号码',validType:'sfz'">
                                    </div>
                                    <div class="commonRow">
                        ...
                        <div class="mui-card">
                            ...
                            <div class="mui-card-content">
                                <div class="mui-input-group">
                                    <div class=" commonRow">
                                        <input class="easyui-textbox" name="apSqhjnx" id="apSqhjnx" data-options="label:'户籍年限(年)',required:true,validType:['numberZ','limitHJ[5]','empty']">
                                    </div>
                                    <div class="readonlyRow commonRow">
                                    ...
                                    <div class="readonlyRow commonRow">
                                        <input class="easyui-textbox" name="apJtrk" id="apJtrk" data-options="label:'家庭人口',required:true,readonly:true,validType:['numberZ','empty']">
                                    </div>
                                    <div class="readonlyRow commonRow">
                        ...
                        <div id="wrap2" style="display: none;">
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        ...
                                        <div class="commonRow">
                                            <input class="easyui-textbox" name="applyFamilyHouses[0].afhZl" id="applyFamilyHouses0afhZl" data-options="label:'房屋地址',required:true,validType:['empty']">
                                        </div>
                                        <div class="commonRow">
                            ...
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        <div class="commonRow">
                                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcYzfzl" id="applyFamilyHouseChangeafhcYzfzl" data-options="label:'原住房地址'">
                                        </div>
                                        <div class="commonRow">
                                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcCqr" id="applyFamilyHouseChangeafhcCqr" data-options="label:'原产权人'">
                                        </div>
                                        <div class="commonRow">
                                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcJzmj" id="applyFamilyHouseChangeafhcJzmj" data-options="label:'建筑面积（m²)'">
                                        </div>
                                        <div class="commonRow">
                        ...
                        <div id="wrap3" style="display: none;">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header">低保信息</div>
                                <!--内容区-->
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        <div class="commonRow">
                                            <input class="easyui-textbox" name="apDbzbh" data-options="label:'低保证编号',required:true">
                                        </div>
                                        <div class="commonRow">
                                            <input class="easyui-textbox" name="apLqrs" data-options="label:'低保领取人数',required:true,validType:['numberZ','empty']">
                                        </div>
                                        <div class="commonRow">
                                            <input class="easyui-datebox" name="apFzsj" data-options="label:'低保发证时间',required:true,editable:false,validType:['minDate','dbAnnual']">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="wrap5" style="display: none;">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span><span class="name">住房状况证明材料</span><span class="reqSpan">*(必填)</span></span><span id="type1" class="detail">详情</span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
...
<script>
    mui.init();
    var person = false;var i=1;//人员控制变量
    ...
    mui(".mui-card").on('tap', '.greenPan', function (e) {
        ...
        if (person) {
            ...
            var perString = $('<div class="mui-card">' +
                ...
                '            </div>' +
                '            <div class="commonRow">' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + addIndex + '].afmSfzh" id="applyFamilyMembers' + addIndex + 'afmSfzh"  data-options="label:\'身份号码\',required:true,validType:[\'sfz\'],events:{keyup:setBirthday}">' +
                '            </div>' +
                '            <div class="commonRow">' +
        ...
        if (data.applyFamilyMembers.length > 2) {
            for (var i = 2; i < data.applyFamilyMembers.length; i++) {
                $('<div class="mui-card">' +
                    ...
                    '            </div>' +
                    '            <div class="commonRow">' +
                    '<input class="easyui-textbox" name="applyFamilyMembers[' + i + '].afmNsr" id="applyFamilyMembers' + i + 'afmNsr"  data-options="label:\'年收入(元)\',required:true,validType:[\'number\',\'empty\'],events:{keyup:changeSr}">' +
                    '            </div>' +
                    '       </div>' +
                    '     </div>' +
                    '</div>').appendTo(".card-container");
        ...
        if (data.volList.length > 0) {
            ...
            for (var i = 0; i < volList.length; i++) {
                for (var k = 0; k < volList[i].volelearcDtls.length; k++) {
                    ...
                    var index = $($("#wrap5 .mui-card:contains('" + volList[i].elearcname + "')")).index();
                    initArray.push(index);
                    $("#wrap5 .mui-card:contains('" + volList[i].elearcname + "')").find(".uploader-list").append('<div id="' + (volList[i].volelearcDtls)[k].volelearcdtlId + '" class="file-item thumbnail id">' +
                        '<img src="' + imageUrl + '">' +
