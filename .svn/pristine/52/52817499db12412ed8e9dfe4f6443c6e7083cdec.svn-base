                ...
                <div class="mui-scroll">
                    <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
                        ...
                        <div id="wrap4" style="display: none;">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">户口簿(含首页)<span class="reqSpan">*(必填)</span></span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">大中专院校毕业证书<span class="reqSpan">*(必填)</span></span><span id="type8" class="detail">详情</span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
