                ...
                <div class="mui-scroll">
                    <form method="post" id="form" class="easyui-form" enctype="multipart/form-data">
                            ...
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        ...
                                        <div class="commonRow readonlyRow">
                                            <select class="easyui-combobox" name="applyFamilyMembers[0].afmHyzk" id="applyFamilyMembers0afmHyzk" data-options="label:'婚姻状况',readonly:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=07'"></select>
                                        </div>
                                        <div class="commonRow readonlyRow">
                                        ...
                                        <div class="commonRow readonlyRow">
                                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmNsr" id="applyFamilyMembers0afmNsr" data-options="label:'个人年收入(元)'">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        ...
                                        <div class="commonRow readonlyRow">
                                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmLxdh" id="applyFamilyMembers1afmLxdh" data-options="label:'联系电话',readonly:true,validType:'phone'">
                                        </div>
                                        <div class="commonRow readonlyRow">
                                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmNsr" id="applyFamilyMembers1afmNsr" data-options="label:'个人年收入(元)'">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        ...
                                        <div class="commonRow readonlyRow" id="cq">
                                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcZrbcje" id="applyFamilyHouseChangeafhcZrbcje" data-options="label:'货币补偿金额(元)',validType:'number',readonly:true">
                                        </div>
                        ...
                        <div id="wrap3" style="display: none;">
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        ...
                                        <div class="readonlyRow commonRow">
                                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfjzmj" id="applyFamilyHouseChangeafhcAzfjzmj" data-options="label:'建筑面积(m²)',readonly:true">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="mui-card">
                                ...
                                <div class="mui-card-content">
                                    <div class="mui-input-group">
                                        <div class="readonlyRow commonRow">
                                            <input class="easyui-textbox" name="apDbzbh" data-options="label:'低保证编号',readonly:true">
                                        </div>
                                        <div class="readonlyRow commonRow">
                                            <input class="easyui-textbox" name="apLqrs" data-options="label:'低保领取人数',readonly:true">
                                        </div>
                                        <div class="readonlyRow commonRow">
                                            <input class="easyui-datebox" name="apFzsj" data-options="label:'低保发证时间',readonly:true">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="wrap5" style="display: none;">
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">收入情况证明材料<span class="reqSpan">*(必填)</span></span><span id="type0" class="detail">详情</span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">住房状况证明材料<span class="reqSpan">*(必填)</span></span><span id="type1" class="detail">详情</span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">家庭成员身份证<span class="reqSpan">*(必填)</span></span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
                            ...
                            <div class="mui-card">
                                <!--页眉，放置标题-->
                                <div class="mui-card-header"><span class="name">户籍所在地社区公示证明<span class="reqSpan">*(必填)</span></span>
                                </div>
                                <!--内容区-->
                                <div class="mui-card-content">
        ...
        if (data.volList.length > 0) {
            ...
            for (var i = 0; i < volList.length; i++) {
                for (var j = 0; j < volList[i].volelearcDtls.length; j++) {
                    ...
                    $("#wrap5 .mui-card:contains('" + volList[i].elearcname + "')").find(".uploader-list").append(
                        '<img src="' + imageUrl + '">')
                }
            }
