...
<div data-options="region:'center',border:'false'">
    <form class="changeForm" method="post" id="changeForm">
        ...
        <div class="formItem">
            <input class="easyui-textbox" name="checkcode" id="checkcode" style="width: 60%" data-options="label:'<i style=\'color:red\'>* </i>短信验证码:',required:true,validType:['empty'],prompt:'改绑手机验证码'">
